...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C15491());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C15491 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C15491() {
            }
