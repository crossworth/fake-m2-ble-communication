...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C01351();
    ...
    class C01365 implements Runnable {

        class C19571 extends ViewPropertyAnimatorListenerAdapter {
            C19571() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C19571());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C15591());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class C15591 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C15591() {
                }
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0140R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0140R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0140R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0140R.styleable.Theme);
            this.background = a.getResourceId(C0140R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0140R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0140R.layout.abc_list_menu_item_layout);
    ...
    class C15562 implements OnApplyWindowInsetsListener {
        C15562() {
        }
    ...
    class C15573 implements OnFitSystemWindowsListener {
        C15573() {
        }
    ...
    class C15584 implements OnAttachListener {
        C15584() {
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C19591 extends ViewPropertyAnimatorListenerAdapter {
            C19591() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C19591());
            }
    ...
    class C19586 extends ViewPropertyAnimatorListenerAdapter {
        C19586() {
        }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0140R.styleable.Theme);
        if (a.hasValue(C0140R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0140R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0140R.styleable.Theme_windowActionBar, false)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0140R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0140R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C15562());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C15573());
                }
            } else if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0140R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context themedContext;
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0140R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0140R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0140R.id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0140R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ViewGroup decorContent = (ViewGroup) this.mWindow.findViewById(16908290);
            ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(C0140R.id.action_bar_activity_content);
            ...
            abcContent.setAttachListener(new C15584());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0140R.styleable.Theme);
        a.getValue(C0140R.styleable.Theme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0140R.styleable.Theme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0140R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0140R.styleable.Theme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0140R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0140R.styleable.Theme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0140R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0140R.styleable.Theme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0140R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0140R.styleable.Theme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0140R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, C0140R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0140R.attr.actionBarSize, outValue, true);
                    ...
                    this.mShowActionModePopup = new C01365();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0140R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C19586());
                    if (this.mActionModePopup != null) {
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0140R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0140R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0140R.color.abc_input_method_navigation_guard));
