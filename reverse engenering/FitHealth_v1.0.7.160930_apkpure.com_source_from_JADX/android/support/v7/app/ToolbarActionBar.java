...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C15602();
    ...
    class C15602 implements OnMenuItemClickListener {
        C15602() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0140R.layout.abc_list_menu_item_layout);
