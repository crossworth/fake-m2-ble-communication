...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C19601();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C19612();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    private TintManager mTintManager;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C15613();

    class C15613 implements ViewPropertyAnimatorUpdateListener {
        C15613() {
        }
    ...
    class C19601 extends ViewPropertyAnimatorListenerAdapter {
        C19601() {
        }
    ...
    class C19612 extends ViewPropertyAnimatorListenerAdapter {
        C19612() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0140R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0140R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0140R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0140R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0140R.styleable.ActionBar, C0140R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0140R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0140R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0140R.attr.actionBarWidgetTheme, outValue, true);
