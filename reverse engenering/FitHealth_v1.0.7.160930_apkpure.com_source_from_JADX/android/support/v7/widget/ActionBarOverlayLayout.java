...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0140R.attr.actionBarSize, 16842841};
    ...
    class C01432 implements Runnable {
        C01432() {
        }
    ...
    class C01443 implements Runnable {
        C01443() {
        }
    ...
    class C19631 extends ViewPropertyAnimatorListenerAdapter {
        C19631() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C19631();
        this.mRemoveActionBarHideOffset = new C01432();
        this.mAddActionBarHideOffset = new C01443();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0140R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0140R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0140R.id.action_bar));
        }
    }
