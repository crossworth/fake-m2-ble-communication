...
public class Toolbar extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C01721();
    ...
    class C15681 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C15681() {
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0140R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C15681();
        this.mShowOverflowMenuRunnable = new C01702();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0140R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0140R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0140R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0140R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = 48;
        int dimensionPixelOffset = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_titleMargins, 0);
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        int marginStart = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0140R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0140R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        this.mContentInsets.setAbsolute(a.getDimensionPixelSize(C0140R.styleable.Toolbar_contentInsetLeft, 0), a.getDimensionPixelSize(C0140R.styleable.Toolbar_contentInsetRight, 0));
        ...
        this.mCollapseIcon = a.getDrawable(C0140R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0140R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0140R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0140R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0140R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0140R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0140R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C0140R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C0140R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0140R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(a.getColor(C0140R.styleable.Toolbar_titleTextColor, -1));
        }
        if (a.hasValue(C0140R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0140R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new ImageButton(getContext(), null, C0140R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new ImageButton(getContext(), null, C0140R.attr.toolbarNavigationButtonStyle);
