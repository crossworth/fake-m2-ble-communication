...
class al {
    ...
    public static Drawable m194a(Context context, String str) throws Exception {
        Bitmap b = m200b(context, str);
        if (b.getNinePatchChunk() == null) {
            return new BitmapDrawable(b);
        }
        Rect rect = new Rect();
        m198a(b.getNinePatchChunk(), rect);
        return new NinePatchDrawable(context.getResources(), b, b.getNinePatchChunk(), rect, null);
    }

    private static Bitmap m193a(InputStream inputStream) throws Exception {
        Bitmap decodeStream = BitmapFactory.decodeStream(inputStream);
        Object a = m199a(decodeStream);
    ...
    private static Bitmap m200b(Context context, String str) throws Exception {
    ...
    private static void m198a(byte[] bArr, Rect rect) {
        rect.left = m192a(bArr, 12);
        rect.right = m192a(bArr, 16);
        rect.top = m192a(bArr, 20);
        rect.bottom = m192a(bArr, 24);
    }

    private static byte[] m199a(Bitmap bitmap) throws IOException {
        int i;
        int i2;
        int i3;
        ...
        for (i2 = 0; i2 < length; i2++) {
            if (width != iArr[i2]) {
                i4++;
                m196a(byteArrayOutputStream, i2);
                width = iArr[i2];
            }
        }
        if (obj2 != null) {
            i4++;
            m196a(byteArrayOutputStream, iArr.length);
        }
        int i5 = i4;
        int i6 = i5 + 1;
        if (obj != null) {
        ...
        m195a(bitmap, toByteArray);
        return toByteArray;
    }

    private static void m195a(Bitmap bitmap, byte[] bArr) {
        int i;
        int i2 = 0;
        ...
        for (i = iArr2.length - 1; i >= 0; i--) {
            if (-16777216 == iArr2[i]) {
                m197a(bArr, 24, (iArr2.length - i) - 2);
                return;
            }
        }
    }

    private static void m196a(OutputStream outputStream, int i) throws IOException {
    ...
    private static void m197a(byte[] bArr, int i, int i2) {
        bArr[i + 0] = (byte) (i2 >> 0);
        bArr[i + 1] = (byte) (i2 >> 8);
        bArr[i + 2] = (byte) (i2 >> 16);
        bArr[i + 3] = (byte) (i2 >> 24);
    ...
    private static int m192a(byte[] bArr, int i) {
