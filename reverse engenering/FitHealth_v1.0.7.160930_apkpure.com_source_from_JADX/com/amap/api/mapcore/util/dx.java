...
/* compiled from: Utils */
public class dx {
    public static void m718a(ByteArrayOutputStream byteArrayOutputStream, String str) {
        m717a(byteArrayOutputStream, (byte) str.length(), m721a(str));
    }

    public static String m715a(byte[] bArr) {
    ...
    public static byte[] m721a(String str) {
    ...
    public static void m717a(ByteArrayOutputStream byteArrayOutputStream, byte b, byte[] bArr) {
        int i = 1;
        try {
            ...
            eb.m742a(e, "Utils", "writeField");
        }
    }

    public static String m722b(String str) {
        if (str == null) {
            return null;
        }
        String b = dr.m674b(m721a(str));
        return ((char) ((b.length() % 26) + 65)) + b;
    }

    public static String m725c(String str) {
        if (str.length() < 2) {
            return "";
        }
        return dr.m670a(str.substring(1));
    }

    public static boolean m719a(JSONObject jSONObject, String str) {
        return jSONObject != null && jSONObject.has(str);
    }

    public static byte[] m720a() {
        int i = 0;
        try {
            ...
            split = new StringBuffer(new String(dr.m675b(new String(bArr)))).reverse().toString().split(SeparatorConstants.SEPARATOR_ADS_ID);
            ...
            eb.m742a(th, "Utils", "getIV");
            return new byte[16];
        }
    }

    static String m714a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
    ...
    public static String m713a(Throwable th) {
        Writer stringWriter;
    ...
    public static String m723b(Map<String, String> map) {
        return m727d(m714a((Map) map));
    }

    public static String m727d(String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                return "";
            }
            ...
            eb.m742a(th, "Utils", "sortParams");
        }
    }

    public static byte[] m724b(byte[] bArr) {
        try {
            return m731g(bArr);
        } catch (Throwable th) {
            eb.m742a(th, "Utils", "gZip");
            return new byte[0];
        }
    }

    public static byte[] m726c(byte[] bArr) {
                ...
                try {
                    ...
                    if (byteArrayOutputStream != null) {
                        try {
                            ...
                            str = "Utils";
                            str2 = "zip2";
                            eb.m742a(th32, str, str2);
                            return bArr2;
                        }
                    }
                } catch (Throwable th5) {
                    th32 = th5;
                    eb.m742a(th32, "Utils", "zip");
                    if (zipOutputStream != null) {
                        zipOutputStream.close();
                    }
                    if (byteArrayOutputStream != null) {
    ...
    static PublicKey m716a(Context context) throws CertificateException, InvalidKeySpecException, NoSuchAlgorithmException, NullPointerException, IOException {
    ...
    static String m728d(byte[] bArr) {
        try {
            return m730f(bArr);
        } catch (Throwable th) {
            eb.m742a(th, "Utils", "HexString");
            return null;
        }
    }

    static String m729e(byte[] bArr) {
        try {
            return m730f(bArr);
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public static String m730f(byte[] bArr) {
        StringBuilder stringBuilder = new StringBuilder();
        if (bArr == null) {
            return null;
        }
    ...
    private static byte[] m731g(byte[] bArr) throws IOException, Throwable {
    ...
    public static String m712a(long j) {
        String str = null;
        try {
