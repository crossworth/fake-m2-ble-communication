...
public class AMapException extends Exception {
    ...
    private void m1159a(String str) {
        if (AMAP_SIGNATURE_ERROR.equals(str)) {
            this.f1100b = 1001;
        } else if (AMAP_INVALID_USER_KEY.equals(str)) {
            this.f1100b = 1002;
        } else if (AMAP_SERVICE_NOT_AVAILBALE.equals(str)) {
            this.f1100b = CODE_AMAP_SERVICE_NOT_AVAILBALE;
        } else if (AMAP_DAILY_QUERY_OVER_LIMIT.equals(str)) {
            this.f1100b = 1004;
        } else if (AMAP_ACCESS_TOO_FREQUENT.equals(str)) {
            this.f1100b = CODE_AMAP_ACCESS_TOO_FREQUENT;
        } else if (AMAP_INVALID_USER_IP.equals(str)) {
            this.f1100b = CODE_AMAP_INVALID_USER_IP;
        } else if (AMAP_INVALID_USER_DOMAIN.equals(str)) {
            this.f1100b = CODE_AMAP_INVALID_USER_DOMAIN;
        } else if (AMAP_INVALID_USER_SCODE.equals(str)) {
            this.f1100b = CODE_AMAP_INVALID_USER_SCODE;
        } else if (AMAP_USERKEY_PLAT_NOMATCH.equals(str)) {
            this.f1100b = CODE_AMAP_USERKEY_PLAT_NOMATCH;
        } else if (AMAP_IP_QUERY_OVER_LIMIT.equals(str)) {
            this.f1100b = CODE_AMAP_IP_QUERY_OVER_LIMIT;
        } else if (AMAP_NOT_SUPPORT_HTTPS.equals(str)) {
            this.f1100b = CODE_AMAP_NOT_SUPPORT_HTTPS;
        } else if (AMAP_INSUFFICIENT_PRIVILEGES.equals(str)) {
            this.f1100b = CODE_AMAP_INSUFFICIENT_PRIVILEGES;
        } else if (AMAP_USER_KEY_RECYCLED.equals(str)) {
            this.f1100b = CODE_AMAP_USER_KEY_RECYCLED;
        } else if (AMAP_ENGINE_RESPONSE_ERROR.equals(str)) {
            this.f1100b = CODE_AMAP_ENGINE_RESPONSE_ERROR;
        } else if (AMAP_ENGINE_RESPONSE_DATA_ERROR.equals(str)) {
            this.f1100b = CODE_AMAP_ENGINE_RESPONSE_DATA_ERROR;
        } else if (AMAP_ENGINE_CONNECT_TIMEOUT.equals(str)) {
            this.f1100b = CODE_AMAP_ENGINE_CONNECT_TIMEOUT;
        } else if (AMAP_ENGINE_RETURN_TIMEOUT.equals(str)) {
            this.f1100b = CODE_AMAP_ENGINE_RETURN_TIMEOUT;
        } else if (AMAP_SERVICE_INVALID_PARAMS.equals(str)) {
            this.f1100b = CODE_AMAP_SERVICE_INVALID_PARAMS;
        } else if (AMAP_SERVICE_MISSING_REQUIRED_PARAMS.equals(str)) {
            this.f1100b = CODE_AMAP_SERVICE_MISSING_REQUIRED_PARAMS;
        } else if (AMAP_SERVICE_ILLEGAL_REQUEST.equals(str)) {
            this.f1100b = CODE_AMAP_SERVICE_ILLEGAL_REQUEST;
        } else if (AMAP_SERVICE_UNKNOWN_ERROR.equals(str)) {
            this.f1100b = CODE_AMAP_SERVICE_UNKNOWN_ERROR;
        } else if ("协议解析错误 - ProtocolException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_ERROR_PROTOCOL;
        } else if ("socket 连接超时 - SocketTimeoutException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_SOCKET_TIMEOUT_EXCEPTION;
        } else if ("url异常 - MalformedURLException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_URL_EXCEPTION;
        } else if ("未知主机 - UnKnowHostException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_UNKNOWHOST_EXCEPTION;
        } else if (AMAP_CLIENT_UNKNOWN_ERROR.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_UNKNOWN_ERROR;
        } else if ("无效的参数 - IllegalArgumentException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_INVALID_PARAMETER;
        } else if (AMAP_CLIENT_NETWORK_EXCEPTION.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_NETWORK_EXCEPTION;
        } else if ("IO 操作异常 - IOException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_IO_EXCEPTION;
        } else if ("空指针异常 - NullPointException".equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_NULLPOINT_EXCEPTION;
        } else if (AMAP_SERVICE_TABLEID_NOT_EXIST.equals(str)) {
            this.f1100b = 2000;
        } else if (AMAP_ID_NOT_EXIST.equals(str)) {
            this.f1100b = CODE_AMAP_ID_NOT_EXIST;
        } else if (AMAP_SERVICE_MAINTENANCE.equals(str)) {
            this.f1100b = CODE_AMAP_SERVICE_MAINTENANCE;
        } else if (AMAP_ENGINE_TABLEID_NOT_EXIST.equals(str)) {
            this.f1100b = CODE_AMAP_ENGINE_TABLEID_NOT_EXIST;
        } else if (AMAP_NEARBY_INVALID_USERID.equals(str)) {
            this.f1100b = CODE_AMAP_NEARBY_INVALID_USERID;
        } else if (AMAP_NEARBY_KEY_NOT_BIND.equals(str)) {
            this.f1100b = CODE_AMAP_NEARBY_KEY_NOT_BIND;
        } else if (AMAP_CLIENT_UPLOADAUTO_STARTED_ERROR.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_UPLOADAUTO_STARTED_ERROR;
        } else if (AMAP_CLIENT_USERID_ILLEGAL.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_USERID_ILLEGAL;
        } else if (AMAP_CLIENT_NEARBY_NULL_RESULT.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_NEARBY_NULL_RESULT;
        } else if (AMAP_CLIENT_UPLOAD_TOO_FREQUENT.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_UPLOAD_TOO_FREQUENT;
        } else if (AMAP_CLIENT_UPLOAD_LOCATION_ERROR.equals(str)) {
            this.f1100b = CODE_AMAP_CLIENT_UPLOAD_LOCATION_ERROR;
        } else if (AMAP_ROUTE_OUT_OF_SERVICE.equals(str)) {
            this.f1100b = 3000;
        } else if (AMAP_ROUTE_NO_ROADS_NEARBY.equals(str)) {
            this.f1100b = CODE_AMAP_ROUTE_NO_ROADS_NEARBY;
        } else if (AMAP_ROUTE_FAIL.equals(str)) {
            this.f1100b = CODE_AMAP_ROUTE_FAIL;
        } else if (AMAP_OVER_DIRECTION_RANGE.equals(str)) {
            this.f1100b = CODE_AMAP_OVER_DIRECTION_RANGE;
        } else if (AMAP_SHARE_LICENSE_IS_EXPIRED.equals(str)) {
            this.f1100b = CODE_AMAP_SHARE_LICENSE_IS_EXPIRED;
        } else if (AMAP_SHARE_FAILURE.equals(str)) {
            this.f1100b = CODE_AMAP_SHARE_FAILURE;
        } else {
            this.f1100b = CODE_AMAP_CLIENT_ERRORCODE_MISSSING;
        }
    }
}
