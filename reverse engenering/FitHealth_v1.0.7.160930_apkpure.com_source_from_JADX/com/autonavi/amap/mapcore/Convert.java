...
public class Convert {
    ...
    public static void convert1bString(byte[] bArr, int i, C0478b c0478b) {
        try {
            c0478b.f2033a = bArr[i];
            c0478b.f2034b = new String(bArr, i + 1, c0478b.f2033a, "UTF-8");
        } catch (Exception e) {
            e.printStackTrace();
            c0478b.f2033a = 0;
            c0478b.f2034b = "";
    ...
    public static void convert2bString(byte[] bArr, int i, C0478b c0478b) {
        try {
            c0478b.f2033a = getShort(bArr, i);
            c0478b.f2034b = new String(bArr, i + 2, c0478b.f2033a, "UTF-8");
        } catch (Exception e) {
            e.printStackTrace();
            c0478b.f2033a = 0;
            c0478b.f2034b = "";
