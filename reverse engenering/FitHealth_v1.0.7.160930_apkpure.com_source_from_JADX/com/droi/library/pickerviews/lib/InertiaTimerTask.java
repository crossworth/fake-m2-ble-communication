...
final class InertiaTimerTask extends TimerTask {
    ...
    public final void run() {
        if (this.f2302a == 2.14748365E9f) {
            if (Math.abs(this.velocityY) <= 2000.0f) {
                this.f2302a = this.velocityY;
        ...
        if (Math.abs(this.f2302a) < 0.0f || Math.abs(this.f2302a) > TitleBar.BACKBTN_LEFT_MARGIN) {
            int i = (int) ((this.f2302a * TitleBar.SHAREBTN_RIGHT_MARGIN) / 1000.0f);
            ...
            if (this.f2302a < 0.0f) {
                this.f2302a += TitleBar.BACKBTN_LEFT_MARGIN;
            } else {
                this.f2302a -= TitleBar.BACKBTN_LEFT_MARGIN;
            }
