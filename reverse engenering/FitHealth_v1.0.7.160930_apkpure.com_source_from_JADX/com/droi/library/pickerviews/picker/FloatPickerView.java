...
public class FloatPickerView extends LinearLayout implements IPickerView {
    ...
    class C16271 implements OnItemSelectedListener {
        C16271() {
        }
    ...
    class C16282 implements OnItemSelectedListener {
        C16282() {
        }
    ...
    private void initView(Context context) {
        View contentView = LayoutInflater.from(context).inflate(C0545R.layout.float_picker_layout, this, true);
        this.numberView = (WheelView) contentView.findViewById(C0545R.id.number_view);
        this.pointView = (WheelView) contentView.findViewById(C0545R.id.point_view);
        this.numberView.setOnItemSelectedListener(new C16271());
        this.pointView.setOnItemSelectedListener(new C16282());
    }
