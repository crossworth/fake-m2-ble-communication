...
public class NumberPickerView extends LinearLayout implements IPickerView {
    ...
    class C16291 implements OnItemSelectedListener {
        C16291() {
        }
    ...
    private void initView(Context context) {
        this.numberView = (WheelView) LayoutInflater.from(context).inflate(C0545R.layout.number_picker_layout, this, true).findViewById(C0545R.id.number_view);
        this.numberView.setOnItemSelectedListener(new C16291());
    }
