...
public class FacebookActivity extends FragmentActivity {
    ...
    private ResContainer f5571R = null;
    private Fragment singleFragment;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.f5571R = ResContainer.get(this);
        setContentView(this.f5571R.layout("com_facebook_activity_layout"));
        ...
        if (fragment == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                ...
                manager.beginTransaction().add(this.f5571R.id("com_facebook_fragment_container"), fragment, FRAGMENT_TAG).commit();
            }
        }
