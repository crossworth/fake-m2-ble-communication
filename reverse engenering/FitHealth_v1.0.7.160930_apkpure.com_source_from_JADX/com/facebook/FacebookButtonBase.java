...
public abstract class FacebookButtonBase extends Button {
    ...
    class C05491 implements OnClickListener {
        C05491() {
        }
    ...
    protected FacebookButtonBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, String analyticsButtonCreatedEventName, int requestCode) {
        ...
        this.f2303R = null;
        this.f2303R = ResContainer.get(getActivity());
        if (defStyleRes == 0) {
            defStyleRes = getDefaultStyleResource();
        }
        if (defStyleRes == 0) {
            defStyleRes = this.f2303R.style("com_facebook_button");
        }
    ...
    private void parseBackgroundAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            if (a.hasValue(0)) {
                ...
                setBackgroundColor(a.getColor(0, this.f2303R.color("com_facebook_blue")));
            }
            a.recycle();
        } catch (Throwable th) {
            a.recycle();
    ...
    private void setupOnClickListener() {
        super.setOnClickListener(new C05491());
    }
}
