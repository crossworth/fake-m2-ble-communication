...
public final class FacebookSdk {
    ...
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new C05511();
    ...
    static class C05511 implements ThreadFactory {
    ...
    static class C05522 implements Callable<Void> {
        C05522() {
        }
    ...
    public static synchronized void sdkInitialize(Context applicationContext) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                getExecutor().execute(new FutureTask(new C05522()));
