...
public final class Profile implements Parcelable {
    public static final Creator<Profile> CREATOR = new C05562();
    ...
    static class C05562 implements Creator {
        C05562() {
        }
    ...
    static class C16411 implements GraphMeRequestWithCacheCallback {
        C16411() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (accessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(), new C16411());
        }
    }
