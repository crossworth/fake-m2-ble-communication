...
public class AppEventsLogger {
    ...
    static class C05623 implements Runnable {
        C05623() {
        }
    ...
    static class C05634 implements Runnable {
        C05634() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C05661();
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C05623(), 0, 15, TimeUnit.SECONDS);
            backgroundExecutor.scheduleAtFixedRate(new C05634(), 0, 86400, TimeUnit.SECONDS);
        }
    }
    ...
    static String getSourceApplication() {
        ...
        if (sourceApplication != null) {
            return openType + SocializeConstants.OP_OPEN_PAREN + sourceApplication + SocializeConstants.OP_CLOSE_PAREN;
        }
        return openType;
    }
