...
public class FacebookAppLinkResolver implements AppLinkResolver {
    ...
    public Task<Map<Uri, AppLink>> getAppLinkFromUrlsInBackground(List<Uri> uris) {
        ...
        appLinkRequestParameters.putString("fields", String.format("%s.fields(%s,%s)", new Object[]{APP_LINK_KEY, APP_LINK_ANDROID_TARGET_KEY, "web"}));
        new GraphRequest(null, "", appLinkRequestParameters, null, new Callback() {
