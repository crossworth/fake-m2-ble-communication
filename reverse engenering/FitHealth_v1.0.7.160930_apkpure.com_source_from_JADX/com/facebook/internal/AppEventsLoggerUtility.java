...
public class AppEventsLoggerUtility {
    private static final Map<GraphAPIActivityType, String> API_ACTIVITY_TYPE_TO_STRING = new C05691();

    static class C05691 extends HashMap<GraphAPIActivityType, String> {
        C05691() {
