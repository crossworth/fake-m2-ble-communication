...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C16521 implements OnCompleteListener {
        C16521() {
        }
    ...
    class C16532 implements OnCompleteListener {
        C16532() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialog.setOnCompleteListener(new C16532());
            } else {
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C16521()).build();
            }
