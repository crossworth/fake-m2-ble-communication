...
public final class Utility {
    ...
    public static int[] intersectRanges(int[] range1, int[] range2) {
        ...
        while (index1 < range1.length && index2 < range2.length) {
            ...
            int newRangeUpper = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            int lower1 = range1[index1];
            int upper1 = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            int lower2 = range2[index2];
            int upper2 = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            ...
            if (newRangeLower != Integer.MIN_VALUE) {
                ...
                if (newRangeUpper == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
    ...
    public static void putCommaSeparatedStringList(Bundle b, String key, ArrayList<String> list) {
        if (list != null) {
            ...
            while (it.hasNext()) {
                ...
                builder.append(SeparatorConstants.SEPARATOR_ADS_ID);
            }
    ...
    public static String getMetadataApplicationId(Context context) {
        Validate.notNull(context, au.aD);
    ...
    private static JSONObject getAppSettingsQueryResponse(String applicationId) {
        ...
        appSettingsParams.putString(APPLICATION_FIELDS, TextUtils.join(SeparatorConstants.SEPARATOR_ADS_ID, APP_SETTING_FIELDS));
    ...
    public static boolean isWebUri(Uri uri) {
        return uri != null && (HttpHost.DEFAULT_SCHEME_NAME.equalsIgnoreCase(uri.getScheme()) || URL_SCHEME.equalsIgnoreCase(uri.getScheme()));
    }
