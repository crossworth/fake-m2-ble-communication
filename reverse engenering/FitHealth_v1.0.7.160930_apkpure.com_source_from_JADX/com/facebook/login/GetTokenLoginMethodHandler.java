...
class GetTokenLoginMethodHandler extends LoginMethodHandler {
    public static final Creator<GetTokenLoginMethodHandler> CREATOR = new C05893();
    private GetTokenClient getTokenClient;

    static class C05893 implements Creator {
        C05893() {
        }
        ...
        if (result != null) {
            ...
            if (currentPermissions == null || !(permissions == null || currentPermissions.containsAll(permissions))) {
                ...
                if (!newPermissions.isEmpty()) {
                    addLoggingExtra("new_permissions", TextUtils.join(SeparatorConstants.SEPARATOR_ADS_ID, newPermissions));
                }
