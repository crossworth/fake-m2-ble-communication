...
class LoginClient implements Parcelable {
    public static final Creator<LoginClient> CREATOR = new C05911();
    ...
    public static class Request implements Parcelable {
        public static final Creator<Request> CREATOR = new C05921();
        ...
        static class C05921 implements Creator {
            C05921() {
            }
    ...
    public static class Result implements Parcelable {
        public static final Creator<Result> CREATOR = new C05931();
        final Code code;
        ...
        static class C05931 implements Creator {
            C05931() {
            }
    ...
    boolean checkInternetPermission() {
        ...
        if (checkPermission("android.permission.INTERNET") != 0) {
            ...
            complete(Result.createErrorResult(this.pendingRequest, ResContainer.getString(activity, "com_facebook_internet_permission_error_title"), ResContainer.getString(activity, "com_facebook_internet_permission_error_message")));
            return false;
        }
    ...
    private void addLoggingExtra(String key, String value, boolean accumulate) {
        ...
        if (this.loggingExtras.containsKey(key) && accumulate) {
            value = ((String) this.loggingExtras.get(key)) + SeparatorConstants.SEPARATOR_ADS_ID + value;
        }
