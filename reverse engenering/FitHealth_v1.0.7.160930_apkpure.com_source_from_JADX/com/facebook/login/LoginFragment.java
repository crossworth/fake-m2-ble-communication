...
public class LoginFragment extends Fragment {
    ...
    private ResContainer f4490R;
    private String callingPackage;
    private LoginClient loginClient;
    private Request request;

    class C16581 implements OnCompletedListener {
        C16581() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.f4490R = ResContainer.get(getActivity());
        ...
        this.loginClient.setOnCompletedListener(new C16581());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(this.f4490R.layout("com_facebook_login_fragment"), container, false);
        this.loginClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                view.findViewById(LoginFragment.this.f4490R.id("com_facebook_login_activity_progress_bar")).setVisibility(0);
            }

            public void onBackgroundProcessingStopped() {
                view.findViewById(LoginFragment.this.f4490R.id("com_facebook_login_activity_progress_bar")).setVisibility(8);
            }
        });
        return view;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(this.f4490R.id("com_facebook_login_activity_progress_bar")).setVisibility(8);
    }
