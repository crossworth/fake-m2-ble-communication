...
public class LoginButton extends FacebookButtonBase {
    ...
    private class LoginClickListener implements OnClickListener {
        ...
        class C05991 implements DialogInterface.OnClickListener {
            C05991() {
            }
        ...
        public void onClick(View v) {
            ...
            if (accessToken == null) {
                ...
                String message;
                String logout = ResContainer.getString(LoginButton.this.getContext(), "com_facebook_loginview_log_out_action");
                String cancel = ResContainer.getString(LoginButton.this.getContext(), "com_facebook_loginview_cancel_action");
                Profile profile = Profile.getCurrentProfile();
                if (profile == null || profile.getName() == null) {
                    message = ResContainer.getString(LoginButton.this.getContext(), "com_facebook_loginview_logged_in_using_facebook");
                } else {
                    message = String.format(ResContainer.getString(LoginButton.this.getContext(), "com_facebook_loginview_logged_in_as"), new Object[]{profile.getName()});
                }
                Builder builder = new Builder(context);
                builder.setMessage(message).setCancelable(true).setPositiveButton(logout, new C05991()).setNegativeButton(cancel, null);
                builder.create().show();
            } else {
                LoginButton.this.getLoginManager().logOut();
            }
    ...
    class C16632 extends AccessTokenTracker {
        C16632() {
        }
    ...
    private void checkToolTipSettings() {
        switch (this.toolTipMode) {
            case AUTOMATIC:
                ...
                return;
            case DISPLAY_ALWAYS:
                displayToolTip(ResContainer.getString(getContext(), "com_facebook_tooltip_default"));
                return;
            default:
                return;
        }
    ...
    protected void configureButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isInEditMode()) {
            ...
            this.accessTokenTracker = new C16632();
        }
        setButtonText();
    }
    ...
    private void parseLoginButtonAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, ResContainer.getStyleableArrts(getContext(), "com_facebook_login_view"), defStyleAttr, defStyleRes);
        try {
            ResContainer R = ResContainer.get(getContext());
            this.confirmLogout = a.getBoolean(R.style("com_facebook_login_view_com_facebook_confirm_logout"), true);
            this.loginText = a.getString(R.style("com_facebook_login_view_com_facebook_login_text"));
            this.logoutText = a.getString(R.style("com_facebook_login_view_com_facebook_logout_text"));
            this.toolTipMode = ToolTipMode.fromInt(a.getInt(R.style("com_facebook_login_view_com_facebook_tooltip_mode"), ToolTipMode.DEFAULT.getValue()));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (text == null) {
            text = ResContainer.getString(getContext(), "com_facebook_loginview_log_in_button_long");
            logInWidth = measureButtonWidth(text);
            if (resolveSize(logInWidth, widthMeasureSpec) < logInWidth) {
                text = ResContainer.getString(getContext(), "com_facebook_loginview_log_in_button");
            }
        }
        logInWidth = measureButtonWidth(text);
        text = this.logoutText;
        if (text == null) {
            text = ResContainer.getString(getContext(), "com_facebook_loginview_log_out_button");
        }
    ...
    private void setButtonText() {
        ...
        if (AccessToken.getCurrentAccessToken() != null) {
            ...
            if (this.logoutText != null) {
                ...
                charSequence = ResContainer.getString(getContext(), "com_facebook_loginview_log_out_button");
            }
            setText(charSequence);
        } else if (this.loginText != null) {
            setText(this.loginText);
        } else {
            String text = ResContainer.getString(getContext(), "com_facebook_loginview_log_in_button_long");
            int width = getWidth();
