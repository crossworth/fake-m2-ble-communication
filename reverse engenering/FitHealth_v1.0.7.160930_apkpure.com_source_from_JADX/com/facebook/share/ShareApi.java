...
public final class ShareApi {
    ...
    static class C16697 implements ValueMapper {
        C16697() {
        }
    ...
    private static <T> void stageCollectionValues(CollectionMapper.Collection<T> collection, OnMapperCompleteListener onCollectionValuesStagedListener) {
        CollectionMapper.iterate(collection, new C16697(), onCollectionValuesStagedListener);
    }
