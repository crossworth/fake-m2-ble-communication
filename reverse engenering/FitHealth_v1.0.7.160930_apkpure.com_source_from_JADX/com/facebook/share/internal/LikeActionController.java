...
public class LikeActionController {
    ...
    private abstract class AbstractRequestWrapper {
        ...
        class C16811 implements Callback {
            C16811() {
            }
        ...
        protected void setRequest(GraphRequest request) {
            ...
            request.setCallback(new C16811());
        }
    ...
    static class C16733 implements CallbackManagerImpl.Callback {
        C16733() {
        }
    ...
    static class C16745 extends AccessTokenTracker {
        C16745() {
        }
    ...
    class C16809 implements RequestCompletionCallback {
        C16809() {
        }
...
*/
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C16733());
                isInitialized = true;
            }
        }
    }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.getCurrentAccessToken() == null) {
            ...
            fetchVerifiedObjectId(new C16809());
        }
    }
