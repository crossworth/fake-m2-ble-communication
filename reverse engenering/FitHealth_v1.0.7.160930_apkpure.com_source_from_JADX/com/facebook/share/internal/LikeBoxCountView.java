...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        this.f2307R = ResContainer.get(context);
        setWillNotDraw(false);
        this.caretHeight = getResources().getDimension(this.f2307R.dimen("com_facebook_likeboxcountview_caret_height"));
        this.caretWidth = getResources().getDimension(this.f2307R.dimen("com_facebook_likeboxcountview_caret_width"));
        this.borderRadius = getResources().getDimension(this.f2307R.dimen("com_facebook_likeboxcountview_border_radius"));
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(this.f2307R.color("com_facebook_likeboxcountview_border_color")));
        this.borderPaint.setStrokeWidth(getResources().getDimension(this.f2307R.dimen("com_facebook_likeboxcountview_border_color")));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(this.f2307R.dimen("com_facebook_likeboxcountview_text_size")));
        this.likeCountLabel.setTextColor(getResources().getColor(this.f2307R.color("com_facebook_likeboxcountview_text_color")));
        this.textPadding = getResources().getDimensionPixelSize(this.f2307R.dimen("com_facebook_likeboxcountview_text_padding"));
        this.additionalTextPadding = getResources().getDimensionPixelSize(this.f2307R.dimen("com_facebook_likeboxcountview_caret_height"));
    }
