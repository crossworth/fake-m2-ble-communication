...
public class VideoUploader {
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new C06131(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
    ...
    static class C16901 extends AccessTokenTracker {
        C16901() {
        }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C06101();

        static class C06101 extends HashSet<Integer> {
            C06101() {
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C06111();

        static class C06111 extends HashSet<Integer> {
            C06111() {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C06121();
        private String chunkEnd;
        private String chunkStart;

        static class C06121 extends HashSet<Integer> {
            C06121() {
