...
public class LikeView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        if (attrs != null && getContext() != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, ResContainer.getStyleableArrts(getContext(), "com_facebook_like_view"));
            if (a != null) {
                this.objectId = Utility.coerceValueIfNullOrEmpty(a.getString(this.f2309R.style("com_facebook_like_view_com_facebook_object_id")), null);
                this.objectType = ObjectType.fromInt(a.getInt(this.f2309R.styleable("com_facebook_like_view_com_facebook_object_type"), ObjectType.DEFAULT.getValue()));
                this.likeViewStyle = Style.fromInt(a.getInt(this.f2309R.styleable("com_facebook_like_view_com_facebook_style"), Style.DEFAULT.getValue()));
                if (this.likeViewStyle == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'style'");
                }
                this.auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(a.getInt(this.f2309R.styleable("com_facebook_like_view_com_facebook_auxiliary_view_position"), AuxiliaryViewPosition.DEFAULT.getValue()));
                if (this.auxiliaryViewPosition == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'auxiliary_view_position'");
                }
                this.horizontalAlignment = HorizontalAlignment.fromInt(a.getInt(this.f2309R.styleable("com_facebook_like_view_com_facebook_horizontal_alignment"), HorizontalAlignment.DEFAULT.getValue()));
                if (this.horizontalAlignment == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'horizontal_alignment'");
                }
                this.foregroundColor = a.getColor(this.f2309R.styleable("com_facebook_like_view_com_facebook_foreground_color"), -1);
                a.recycle();
            }
        }
    }
    ...
    private void initialize(Context context) {
        this.f2309R = ResContainer.get(context);
        this.edgePadding = getResources().getDimensionPixelSize(this.f2309R.dimen("com_facebook_likeview_edge_padding"));
        this.internalPadding = getResources().getDimensionPixelSize(this.f2309R.dimen("com_facebook_likeview_internal_padding"));
        if (this.foregroundColor == -1) {
            this.foregroundColor = getResources().getColor(this.f2309R.color("com_facebook_likeview_text_color"));
        }
    ...
    private void initializeLikeButton(Context context) {
        ...
        this.likeButton.setOnClickListener(new C06261());
        this.likeButton.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
    }

    private void initializeSocialSentenceView(Context context) {
        this.socialSentenceView = new TextView(context);
        this.socialSentenceView.setTextSize(0, getResources().getDimension(this.f2309R.dimen("com_facebook_likeview_text_size")));
