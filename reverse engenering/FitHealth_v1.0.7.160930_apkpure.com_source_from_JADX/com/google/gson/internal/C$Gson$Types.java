...
public final class C$Gson$Types {
    ...
    public static Type getCollectionElementType(Type context, Class<?> contextRawType) {
        return ((ParameterizedType) C$Gson$Types.getSupertype(context, contextRawType, Collection.class)).getActualTypeArguments()[0];
    }

    public static Type[] getMapKeyAndValueTypes(Type context, Class<?> contextRawType) {
        if (context != Properties.class) {
            return ((ParameterizedType) C$Gson$Types.getSupertype(context, contextRawType, Map.class)).getActualTypeArguments();
        }
