...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C06451();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C06473();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C06484();
    private static final TypeEvaluator sFloatEvaluator = new FloatEvaluator();
    private static long sFrameDelay = DEFAULT_FRAME_DELAY;
    private static final TypeEvaluator sIntEvaluator = new IntEvaluator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C06462();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C06495();
    ...
    static class C06451 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C06451() {
        }
    ...
    static class C06462 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C06462() {
        }
    ...
    static class C06473 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C06473() {
        }
    ...
    static class C06484 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C06484() {
        }
    ...
    static class C06495 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C06495() {
        }
