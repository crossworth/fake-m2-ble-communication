...
class ReflectiveProperty<T, V> extends Property<T, V> {
    ...
    public ReflectiveProperty(Class<T> propertyHolder, Class<V> valueType, String name) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!typesMatch(valueType, fieldType)) {
                            throw new NoSuchPropertyException("Underlying type (" + fieldType + ") " + "does not match Property type (" + valueType + SocializeConstants.OP_CLOSE_PAREN);
                        }
                        return;
        ...
        throw new NoSuchPropertyException("Underlying type (" + getterType + ") " + "does not match Property type (" + valueType + SocializeConstants.OP_CLOSE_PAREN);
    }
