...
public class ImageObject extends BaseMediaObject {
    public static final Creator<ImageObject> CREATOR = new C06541();
    private static final int DATA_SIZE = 2097152;
    public byte[] imageData;
    public String imagePath;

    class C06541 implements Creator<ImageObject> {
        C06541() {
        }
    ...
    public final void setImageObject(Bitmap bitmap) {
        ...
        try {
            ...
            try {
                ...
                try {
                    e.printStackTrace();
                    LogUtil.m2215e("Weibo.ImageObject", "put thumb failed");
                    if (os != null) {
                        try {
                            os.close();
    ...
    public boolean checkArgs() {
        if (this.imageData == null && this.imagePath == null) {
            LogUtil.m2215e("Weibo.ImageObject", "imageData and imagePath are null");
            return false;
        } else if (this.imageData != null && this.imageData.length > 2097152) {
            LogUtil.m2215e("Weibo.ImageObject", "imageData is too large");
            return false;
            ...
            if (this.imagePath != null) {
                ...
                try {
                    if (!file.exists() || file.length() == 0 || file.length() > 10485760) {
                        LogUtil.m2215e("Weibo.ImageObject", "checkArgs fail, image content is too large or not exists");
                        return false;
                    }
            ...
            LogUtil.m2215e("Weibo.ImageObject", "imagePath is too length");
            return false;
        }
    }
