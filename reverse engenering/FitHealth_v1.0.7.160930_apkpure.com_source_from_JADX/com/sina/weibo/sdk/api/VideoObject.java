...
public class VideoObject extends BaseMediaObject {
    public static final Creator<VideoObject> CREATOR = new C06571();
    ...
    class C06571 implements Creator<VideoObject> {
        C06571() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            LogUtil.m2215e("Weibo.VideoObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            LogUtil.m2215e("Weibo.VideoObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            LogUtil.m2215e("Weibo.VideoObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
