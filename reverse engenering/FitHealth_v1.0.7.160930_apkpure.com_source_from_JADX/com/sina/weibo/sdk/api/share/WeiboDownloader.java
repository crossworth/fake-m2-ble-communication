...
public class WeiboDownloader {
    ...
    class C06601 implements OnClickListener {
        private final /* synthetic */ Context val$context;

        C06601(Context context) {
    ...
    class C06612 implements OnClickListener {
        private final /* synthetic */ IWeiboDownloadListener val$listener;

        C06612(IWeiboDownloadListener iWeiboDownloadListener) {
    ...
    public static Dialog createDownloadConfirmDialog(Context context, IWeiboDownloadListener listener) {
        ...
        return new Builder(context).setMessage(prompt).setTitle(title).setPositiveButton(ok, new C06601(context)).setNegativeButton(cancel, new C06612(listener)).create();
    }
