...
public final class WeiboPageUtilsV2 {
    ...
    public static void postNewWeibo(Context context, HashMap<String, String> params) throws WeiboNotInstalledException {
        ...
        CommonUtils.openWeiboActivity(context, "android.intent.action.VIEW", uri.toString(), (String) params.get("packagename"));
    }
    ...
    public static void viewUserInfo(Context context, HashMap<String, String> params) throws WeiboNotInstalledException {
        if (context == null) {
            throw new WeiboIllegalParameterException(ExceptionMsg.CONTEXT_ERROR);
        } else if (params == null || (TextUtils.isEmpty((CharSequence) params.get("uid")) && TextUtils.isEmpty((CharSequence) params.get(ParamKey.NICK)))) {
    ...
    public static void viewUsertrends(Context context, HashMap<String, String> params) throws WeiboNotInstalledException {
        if (context == null) {
            throw new WeiboIllegalParameterException(ExceptionMsg.CONTEXT_ERROR);
        } else if (params == null || TextUtils.isEmpty((CharSequence) params.get("uid"))) {
            throw new WeiboIllegalParameterException(ExceptionMsg.UID_NICK_ERROR);
        } else {
    ...
    public static void openInWeiboBrowser(Context context, String url, String sinainternalbrowser, String extParam, String packageName) throws WeiboNotInstalledException {
        ...
        } else if (TextUtils.isEmpty(sinainternalbrowser) || "topnav".equals(sinainternalbrowser) || SocializeProtocolConstants.PROTOCOL_KEY_DEFAULT.equals(sinainternalbrowser) || "fullscreen".equals(sinainternalbrowser)) {
    ...
    public static void displayInWeiboMap(Context context, HashMap<String, String> params) throws WeiboNotInstalledException {
        ...
        String offset = "";
        if (params != null) {
            lon = (String) params.get("longitude");
            lat = (String) params.get("latitude");
        ...
        if (params != null) {
            openInWeiboBrowser(context, String.format(mapUrl, new Object[]{lon, lat, offset}), SocializeProtocolConstants.PROTOCOL_KEY_DEFAULT, (String) params.get(ParamKey.EXTPARAM), packageName);
        }
    }
