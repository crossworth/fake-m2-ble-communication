...
public class Constants {
    ...
    public static String PACKAGE_QQ = MOBILEQQ_PACKAGE_NAME;
    ...
    public static final String SDK_QUA = "V1_AND_OpenSDK_2.3.1_1077_RDM_B";
    public static final String SDK_VERSION = "2.3.1";
    public static final String SDK_VERSION_STRING = "Android_SDK_2.3.1";
