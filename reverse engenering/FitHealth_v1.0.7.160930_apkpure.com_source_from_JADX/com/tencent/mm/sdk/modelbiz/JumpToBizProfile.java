    ...
    public static class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            if (this.toUserName == null || this.toUserName.length() == 0) {
                C0765a.m2514a(TAG, "checkArgs fail, toUserName is invalid");
                return false;
            } else if (this.extMsg != null && this.extMsg.length() > 1024) {
                C0765a.m2514a(TAG, "ext msg is not null, while the length exceed 1024 bytes");
                return false;
            } else if (this.profileType != 1 || (this.extMsg != null && this.extMsg.length() != 0)) {
                return true;
            } else {
                C0765a.m2514a(TAG, "scene is jump to hardware profile, while extmsg is null");
                return false;
            }
        }
