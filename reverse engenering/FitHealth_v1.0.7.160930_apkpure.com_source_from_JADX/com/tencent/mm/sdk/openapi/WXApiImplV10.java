...
import com.tencent.mm.sdk.p015a.C0763a;
import com.tencent.mm.sdk.p015a.C0763a.C0759a;
import com.tencent.mm.sdk.p015a.p016a.C0761a;
import com.tencent.mm.sdk.p015a.p016a.C0761a.C0760a;
import com.tencent.mm.sdk.p015a.p016a.C0762b;
import com.tencent.mm.sdk.p017b.C0765a;
import com.tencent.wxop.stat.C0875a;
import com.tencent.wxop.stat.C0894c;
import com.tencent.wxop.stat.C0895d;
...
final class WXApiImplV10 implements IWXAPI {
    ...
    private static final class ActivityLifecycleCb implements ActivityLifecycleCallbacks {
        ...
        class C07731 implements Runnable {
            ...
            public void run() {
                if (WXApiImplV10.activityCb != null && ActivityLifecycleCb.this.isForeground) {
                    ...
                    C0896e.m2990d(ActivityLifecycleCb.this.context, "onBackground_WX");
        ...
        class C07742 implements Runnable {
            ...
            public void run() {
                if (WXApiImplV10.activityCb != null && !ActivityLifecycleCb.this.isForeground) {
                    ...
                    C0896e.m2990d(ActivityLifecycleCb.this.context, "onForeground_WX");
        ...
        private ActivityLifecycleCb(Context context) {
            ...
            this.onPausedRunnable = new C07731();
            this.onResumedRunnable = new C07742();
    ...
    WXApiImplV10(Context context, String str, boolean z) {
        C0765a.m2518d(TAG, "<init>, appId = " + str + ", checkSignature = " + z);
        this.context = context;
        this.appId = str;
    ...
    private boolean checkSumConsistent(byte[] bArr, byte[] bArr2) {
        if (bArr == null || bArr.length == 0 || bArr2 == null || bArr2.length == 0) {
            C0765a.m2514a(TAG, "checkSumConsistent fail, invalid arguments");
            return false;
        } else if (bArr.length != bArr2.length) {
            C0765a.m2514a(TAG, "checkSumConsistent fail, length is different");
            return false;
        } else {
    ...
    private void initMta(Context context, String str) {
        ...
        C0894c.m2940b(context, str2);
        C0894c.m2965w();
        C0894c.m2936a(C0895d.PERIOD);
        C0894c.m2962t();
        C0894c.m2942c(context, "Wechat_Sdk");
        try {
            C0896e.m2987a(context, str2, "2.0.3");
        } catch (C0875a e) {
            e.printStackTrace();
        }
    }
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            C0765a.m2518d(TAG, "pay, set wxappPayEntryClassname = " + wxappPayEntryClassname);
            if (wxappPayEntryClassname == null) {
                C0765a.m2514a(TAG, "pay fail, wxappPayEntryClassname is null");
                return false;
            }
        }
        C0759a c0759a = new C0759a();
        c0759a.f2638n = bundle;
        c0759a.f2635k = WXApp.WXAPP_PACKAGE_NAME;
        c0759a.f2636l = wxappPayEntryClassname;
        return C0763a.m2508a(context, c0759a);
    }

    public final void detach() {
        C0765a.m2518d(TAG, "detach");
        this.detached = true;
    ...
    public final int getWXAppSupportAPI() {
        if (this.detached) {
            ...
            C0765a.m2514a(TAG, "open wx app failed, not installed or signature check failed");
            return 0;
        }
    }
    ...
    public final boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        if (!WXApiImplComm.isIntentFromWx(intent, Token.WX_TOKEN_VALUE_MSG)) {
            C0765a.m2517c(TAG, "handleIntent fail, intent not from weixin msg");
            return false;
            ...
            if (stringExtra2 == null || stringExtra2.length() == 0) {
                C0765a.m2514a(TAG, "invalid argument");
                return false;
            } else if (checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), C0762b.m2507a(stringExtra, intExtra, stringExtra2))) {
                ...
                switch (intExtra2) {
                    ...
                    case 9:
                        ...
                        return true;
                    default:
                        C0765a.m2514a(TAG, "unknown cmd = " + intExtra2);
                        return false;
                }
            } else {
                C0765a.m2514a(TAG, "checksum fail");
                return false;
            }
        }
    }
    ...
    public final boolean openWXApp() {
        if (this.detached) {
            ...
            try {
                ...
                C0765a.m2514a(TAG, "startActivity fail, exception = " + e.getMessage());
                return false;
            }
        } else {
            C0765a.m2514a(TAG, "open wx app failed, not installed or signature check failed");
        ...
        if (this.detached) {
            ...
            if (activityCb == null && VERSION.SDK_INT >= 14) {
                if (this.context instanceof Activity) {
                    ...
                    C0765a.m2516b(TAG, "context is not instanceof Activity or Service, disable WXStat");
                }
            }
            C0765a.m2518d(TAG, "registerApp, appId = " + str);
            if (str != null) {
                this.appId = str;
            }
            C0765a.m2518d(TAG, "register app " + this.context.getPackageName());
            C0760a c0760a = new C0760a();
            c0760a.f2641o = WXApp.WXAPP_PACKAGE_NAME;
            c0760a.f2642p = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
            c0760a.f2639m = "weixin://registerapp?appid=" + this.appId;
            return C0761a.m2506a(this.context, c0760a);
        } else {
            C0765a.m2514a(TAG, "register app failed for wechat app signature check failed");
            return false;
        }
    }
    ...
    public final boolean sendReq(BaseReq baseReq) {
        if (this.detached) {
            ...
            C0765a.m2514a(TAG, "sendReq failed for wechat app signature check failed");
            return false;
        } else if (baseReq.checkArgs()) {
            C0765a.m2518d(TAG, "sendReq, req type = " + baseReq.getType());
            ...
            C0759a c0759a = new C0759a();
            c0759a.f2638n = bundle;
            c0759a.f2637m = "weixin://sendreq?appid=" + this.appId;
            c0759a.f2635k = WXApp.WXAPP_PACKAGE_NAME;
            c0759a.f2636l = WXApp.WXAPP_MSG_ENTRY_CLASSNAME;
            return C0763a.m2508a(this.context, c0759a);
        } else {
            C0765a.m2514a(TAG, "sendReq checkArgs fail");
            return false;
        }
    }
    ...
    public final boolean sendResp(BaseResp baseResp) {
        if (this.detached) {
            ...
            C0765a.m2514a(TAG, "sendResp failed for wechat app signature check failed");
            return false;
            ...
            C0759a c0759a = new C0759a();
            c0759a.f2638n = bundle;
            c0759a.f2637m = "weixin://sendresp?appid=" + this.appId;
            c0759a.f2635k = WXApp.WXAPP_PACKAGE_NAME;
            c0759a.f2636l = WXApp.WXAPP_MSG_ENTRY_CLASSNAME;
            return C0763a.m2508a(this.context, c0759a);
        } else {
            C0765a.m2514a(TAG, "sendResp checkArgs fail");
            return false;
        }
    }
    ...
    public final void unregisterApp() {
        if (this.detached) {
            ...
            C0765a.m2518d(TAG, "unregisterApp, appId = " + this.appId);
            if (this.appId == null || this.appId.length() == 0) {
                C0765a.m2514a(TAG, "unregisterApp fail, appId is empty");
                return;
            }
            C0765a.m2518d(TAG, "unregister app " + this.context.getPackageName());
            C0760a c0760a = new C0760a();
            c0760a.f2641o = WXApp.WXAPP_PACKAGE_NAME;
            c0760a.f2642p = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
            c0760a.f2639m = "weixin://unregisterapp?appid=" + this.appId;
            C0761a.m2506a(this.context, c0760a);
        } else {
            C0765a.m2514a(TAG, "unregister app failed for wechat app signature check failed");
        }
    }
}
