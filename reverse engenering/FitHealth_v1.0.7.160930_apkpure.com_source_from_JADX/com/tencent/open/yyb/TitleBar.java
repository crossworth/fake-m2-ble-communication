...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context) {
        ...
        setBackgroundDrawable(C0820b.m2602a(SOURCE_TITLEBAR, context));
        initBackLayout();
        initShareBtn();
    }
    ...
    private void initBackBtn() {
        ...
        this.backBtn.setBackgroundDrawable(C0820b.m2602a(SOURCE_BACK_BTN, getContext()));
    ...
    private void initShareBtn() {
        ...
        this.shareBtn.setBackgroundDrawable(C0820b.m2602a(SOURCE_MORE_BTN, getContext()));
