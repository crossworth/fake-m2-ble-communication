...
final class ac extends SQLiteOpenHelper {
    ...
    public ac(Context context, String str) {
        ...
        if (C0894c.m2949k()) {
            C0908t.bZ.m2851b("SQLiteOpenHelper " + this.f3008a);
        }
    }

    private static void m2839a(SQLiteDatabase sQLiteDatabase) {
        Throwable th;
        String str = null;
        Cursor query;
        try {
            ...
            try {
                ...
                if (query.moveToNext()) {
                    ...
                    query.getString(2);
                    query.getLong(3);
                    contentValues.put("uid", C0891r.m2922q(str));
                }
                if (str != null) {
    ...
    private static void m2840b(SQLiteDatabase sQLiteDatabase) {
        Cursor query;
        Throwable th;
        Cursor cursor;
        try {
            ...
            try {
                ...
                for (ad adVar : arrayList) {
                    contentValues.put("content", C0891r.m2922q(adVar.f3011b));
                    sQLiteDatabase.update("events", contentValues, "event_id=?", new String[]{Long.toString(adVar.f3009K)});
                }
                if (query != null) {
                    query.close();
                }
    ...
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        C0908t.bZ.debug("upgrade DB from oldVersion " + i + " to newVersion " + i2);
        if (i == 1) {
            sQLiteDatabase.execSQL("create table if not exists keyvalues(key TEXT PRIMARY KEY NOT NULL, value TEXT)");
            m2839a(sQLiteDatabase);
            m2840b(sQLiteDatabase);
        }
        if (i == 2) {
            m2839a(sQLiteDatabase);
            m2840b(sQLiteDatabase);
