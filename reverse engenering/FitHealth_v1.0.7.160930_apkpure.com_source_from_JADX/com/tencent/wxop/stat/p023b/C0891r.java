...
public final class C0891r {
    ...
    private static WifiInfo m2913T(Context context) {
    ...
    public static String m2914U(Context context) {
        try {
            WifiInfo T = C0891r.m2913T(context);
            if (T != null) {
                return T.getBSSID();
            }
        } catch (Throwable th) {
    ...
    public static String m2915V(Context context) {
        try {
            WifiInfo T = C0891r.m2913T(context);
            if (T != null) {
                return T.getSSID();
    ...
    public static boolean m2916W(Context context) {
        try {
    ...
    public static JSONArray m2917X(Context context) {
        try {
            if (C0891r.m2919a(context, "android.permission.INTERNET") && C0891r.m2919a(context, "android.permission.ACCESS_NETWORK_STATE")) {
                ...
                if (wifiManager != null) {
                    ...
                    if (scanResults != null && scanResults.size() > 0) {
                        Collections.sort(scanResults, new C0892s());
    ...
    public static void m2918a(JSONObject jSONObject, String str, String str2) {
        if (str2 != null) {
            try {
                if (str2.length() > 0) {
    ...
    public static boolean m2919a(Context context, String str) {
        try {
    ...
    public static String m2920b(Context context) {
        try {
    ...
    public static String m2921c(Context context) {
        if (C0891r.m2919a(context, "android.permission.ACCESS_WIFI_STATE")) {
            try {
                WifiManager wifiManager = (WifiManager) context.getSystemService("wifi");
    ...
    public static String m2922q(String str) {
        if (str == null) {
            return null;
        }
        ...
        try {
            return new String(C0883h.m2866e(C0882g.m2863b(str.getBytes("UTF-8"))), "UTF-8");
        } catch (Throwable th) {
            Log.e("MtaSDK", "encode error", th);
            return str;
        }
    ...
    public static String m2923t(String str) {
        if (str == null) {
            return null;
        }
        if (VERSION.SDK_INT < 8) {
        ...
        try {
            return new String(C0882g.m2864c(C0883h.m2865d(str.getBytes("UTF-8"))), "UTF-8");
        } catch (Throwable th) {
