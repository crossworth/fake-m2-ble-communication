...
public class SocialResHelper {
    ...
    public static class Builder {
        ...
        class C09531 extends AsyncTask<Object, Integer, Drawable> {
            C09531() {
            }
            ...
            protected Drawable doInBackground(Object... objArr) {
                ...
                try {
                    ...
                    Log.m3260w(SocialResHelper.TAG, e2.toString());
                }
                return drawable;
            }
        }
        ...
        public void doBindTask() {
            ...
            try {
                ...
                Log.m3252e(SocialResHelper.TAG, "can't get from cache.", e);
            ...
            switch (this.mLoadMode) {
                case LOAD_CACHE_ONLY:
                    ...
                    if (cachedFile == null || !cachedFile.exists()) {
                        Log.m3251e(SocialResHelper.TAG, "cache is not exists");
                        return;
                    }
        ...
        private void fetchNetElsCache(Drawable drawable) {
            if (drawable == null) {
                new C09531().execute(new Object[0]);
                return;
            }
        ...
        private void doBind(Context context, ImageView imageView, Drawable drawable, boolean z, BindDrawableListener bindDrawableListener, Animation animation, boolean z2, int i) {
            if (drawable == null || imageView == null) {
                ...
                Log.m3260w(SocialResHelper.TAG, "bind drawable failed. drawable [" + drawable + "]  imageView[+" + imageView + "+]");
                return;
            }
            File cachedFile;
            if (z2) {
                        ...
                        try {
                            ...
                            if (fileOutputStream != null) {
                                try {
                                    ...
                                    Log.m3248d(TAG, e.getMessage());
                                }
                            }
                        } catch (IOException e2) {
                            Log.m3248d(TAG, e2.getMessage());
                            if (fileOutputStream != null) {
                                try {
                                    fileOutputStream.close();
                                } catch (IOException e22) {
                                    Log.m3248d(TAG, e22.getMessage());
                                }
                            }
                        } catch (Throwable th3) {
                            if (fileOutputStream != null) {
                            ...
                            try {
                                ...
                                if (fileOutputStream != null) {
                                    try {
                                        ...
                                        Log.m3248d(TAG, e32.getMessage());
                                    }
                                }
                            } catch (IOException e322) {
                                Log.m3248d(TAG, e322.getMessage());
                                if (fileOutputStream != null) {
                                    try {
                                        fileOutputStream.close();
                                    } catch (IOException e3222) {
                                        Log.m3248d(TAG, e3222.getMessage());
                                    }
                                }
                            } catch (Throwable th5) {
                                if (fileOutputStream != null) {
                                    try {
                                        ...
                                        Log.m3248d(TAG, e32222.getMessage());
                                    }
                                }
                            }
                        }
