...
@SignalCode(messageCode = 111006)
public class GetPushReq {
    @ByteField(index = 1)
    ...
    public String toString() {
        return "GetPushReq [terminalInfo=" + this.terminalInfo + ", packageName=" + this.packageName + ", version=" + this.version + ", reserved1=" + this.reserved1 + ", reserved2=" + this.reserved2 + "]";
    }
}
