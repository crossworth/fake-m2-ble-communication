...
@SignalCode(messageCode = 111017)
public class GetSDKDownloadReq {
    @ByteField(index = 1)
    ...
    public String toString() {
        return "GetSDKDownloadReq [terminalInfo=" + this.terminalInfo + ", packageName=" + this.packageName + ", reserved1=" + this.reserved1 + ", reserved2=" + this.reserved2 + "]";
    }
}
