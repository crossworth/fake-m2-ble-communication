...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private float mLastMotionY = GroundOverlayOptions.NO_DIMENSION;
    ...
    class C10951 implements OnGlobalLayoutListener {
        C10951() {
        }
    ...
    class C11006 implements Runnable {
        C11006() {
        }
    ...
    class C11017 implements Runnable {
        C11017() {
        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new C10951());
    }
    ...
    public void onPullDownRefreshComplete() {
        if (isPullRefreshing()) {
            ...
            postDelayed(new C10973(), getSmoothScrollDuration());
            resetHeaderLayout();
    ...
    public void onPullUpRefreshComplete() {
        if (isPullLoading()) {
            ...
            postDelayed(new C10984(), getSmoothScrollDuration());
            resetFooterLayout();
            setInterceptTouchEventEnabled(false);
        }
    }
    ...
    protected void startRefreshing() {
        if (!isPullRefreshing()) {
            ...
            if (this.mRefreshListener != null) {
                postDelayed(new C11006(), getSmoothScrollDuration());
            }
        }
    }
    ...
    protected void startLoading() {
        if (!isPullLoading()) {
            ...
            if (this.mRefreshListener != null) {
                postDelayed(new C11017(), getSmoothScrollDuration());
            }
        }
    }
