...
public abstract class TosAbsSpinner extends TosAdapterView<SpinnerAdapter> {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C11341();
        int position;
        long selectedId;

        static class C11341 implements Creator<SavedState> {
            C11341() {
            }
    ...
    public TosAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mRecycler = new RecycleBin();
        initAbsSpinner();
        TypedArray a = context.obtainStyledAttributes(attrs, C1400R.styleable.AbsSpinner, defStyle, 0);
