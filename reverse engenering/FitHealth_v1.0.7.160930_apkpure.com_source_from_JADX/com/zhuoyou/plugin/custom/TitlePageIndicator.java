...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C12281();
        int currentPage;

        static class C12281 implements Creator<SavedState> {
            C12281() {
            }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C1400R.styleable.TitlePageIndicator, defStyle, 0);
