...
public class XListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        this.mHeaderTimeViewTitle = (TextView) findViewById(R.id.xlistview_header_time_text);
        this.mHeaderTimeView = (TextView) findViewById(R.id.xlistview_header_time);
    ...
    private void setLastUpdatedLabel() {
        String label = PreferenceManager.getDefaultSharedPreferences(this.sContext).getString("sync_device_time", "");
        ...
        if (state != this.mState) {
            ...
            switch (state) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    this.mHintTextView.setText(R.string.xlistview_header_hint_connecting);
                    break;
            }
            this.mState = state;
        }
