...
public class DataBaseContants {
    ...
    public static final Uri CONTENT_DELETE_URI = Uri.parse("content://com.zhuoyou.plugin.database/cloud");
    public static final Uri CONTENT_MSG_URI = Uri.parse("content://com.zhuoyou.plugin.database/action_msg_info");
    public static final Uri CONTENT_URI = Uri.parse("content://com.zhuoyou.plugin.database/data");
    public static final Uri CONTENT_URI_GPSSPORT = Uri.parse("content://com.zhuoyou.plugin.database/gps_sport2");
    public static final Uri CONTENT_URI_GPSSYNC = Uri.parse("content://com.zhuoyou.plugin.database/gps_sync");
    public static final Uri CONTENT_URI_OPERATION = Uri.parse("content://com.zhuoyou.plugin.database/operation_time2");
    public static final Uri CONTENT_URI_POINT = Uri.parse("content://com.zhuoyou.plugin.database/point_message2");
    public static final Uri CONTENT_URI_TEMPPOINT = Uri.parse("content://com.zhuoyou.plugin.database/point_temp");
    ...
    public static final String HEART_RATE_COUNT = "heart_rate_count";
