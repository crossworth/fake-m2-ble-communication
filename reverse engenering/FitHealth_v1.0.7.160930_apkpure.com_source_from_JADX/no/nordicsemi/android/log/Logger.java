...
public class Logger {
    ...
    public static void m3381d(ILogSession session, String message) {
        log(session, 0, message);
    }

    public static void m3387v(ILogSession session, String message) {
        log(session, 1, message);
    }

    public static void m3385i(ILogSession session, String message) {
        log(session, 5, message);
    }

    public static void m3379a(ILogSession session, String message) {
        log(session, 10, message);
    }

    public static void m3389w(ILogSession session, String message) {
        log(session, 15, message);
    }

    public static void m3383e(ILogSession session, String message) {
    ...
    public static void log(ILogSession session, int level, String message) {
        if (session != null) {
            ContentValues values = new ContentValues();
            values.put(LogColumns.LEVEL, Integer.valueOf(level));
    ...
    public static void m3380d(ILogSession session, int messageResId, Object... params) {
        log(session, 0, messageResId, params);
    }

    public static void m3386v(ILogSession session, int messageResId, Object... params) {
        log(session, 1, messageResId, params);
    }

    public static void m3384i(ILogSession session, int messageResId, Object... params) {
        log(session, 5, messageResId, params);
    }

    public static void m3378a(ILogSession session, int messageResId, Object... params) {
        log(session, 10, messageResId, params);
    }

    public static void m3388w(ILogSession session, int messageResId, Object... params) {
        log(session, 15, messageResId, params);
    }

    public static void m3382e(ILogSession session, int messageResId, Object... params) {
