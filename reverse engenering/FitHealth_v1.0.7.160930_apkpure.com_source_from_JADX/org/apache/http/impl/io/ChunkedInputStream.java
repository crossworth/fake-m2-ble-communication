...
public class ChunkedInputStream extends InputStream {
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        if (this.closed) {
            ...
            this.eof = true;
            throw new TruncatedChunkException(new StringBuffer().append("Truncated chunk ( expected size: ").append(this.chunkSize).append("; actual size: ").append(this.pos).append(SocializeConstants.OP_CLOSE_PAREN).toString());
        }
    }
