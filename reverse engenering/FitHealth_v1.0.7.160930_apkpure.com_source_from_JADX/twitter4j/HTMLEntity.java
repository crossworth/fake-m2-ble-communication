...
final class HTMLEntity {
    ...
    static {
        ...
        entities[an.f2220j] = new String[]{"&Xi;", "&#926;", "Ξ"};
        entities[an.f2210case] = new String[]{"&Omicron;", "&#927;", "Ο"};
        entities[112] = new String[]{"&Pi;", "&#928;", "Π"};
        entities[CustomCmd.CMD_SYNC_SPORT_DATA] = new String[]{"&Rho;", "&#929;", "Ρ"};
        entities[114] = new String[]{"&Sigma;", "&#931;", "Σ"};
        entities[115] = new String[]{"&Tau;", "&#932;", "Τ"};
        entities[CustomCmd.CMD_SYNC_PERSONAL_DATA] = new String[]{"&Upsilon;", "&#933;", "Υ"};
        ...
        entities[CustomCmd.CMD_SYNC_SLEEP_MSG] = new String[]{"&iota;", "&#953;", "ι"};
        ...
        entities[ShareActivity.WEIBO_MAX_LENGTH] = new String[]{"&tau;", "&#964;", "τ"};
        ...
        entities[C1507j.f3829b] = new String[]{"&larr;", "&#8592;", "←"};
        entities[BDLocation.TypeNetWorkLocation] = new String[]{"&uarr;", "&#8593;", "↑"};
        entities[162] = new String[]{"&rarr;", "&#8594;", "→"};
        entities[163] = new String[]{"&darr;", "&#8595;", "↓"};
        ...
        entities[an.f2211char] = new String[]{"&lceil;", "&#8968;", "⌈"};
        ...
        entities[SocializeConstants.MASK_USER_CENTER_HIDE_AREA] = new String[]{"&rsquo;", "&#8217;", "’"};
        entities[241] = new String[]{"&sbquo;", "&#8218;", "‚"};
        entities[242] = new String[]{"&ldquo;", "&#8220;", "“"};
        entities[243] = new String[]{"&rdquo;", "&#8221;", "”"};
        entities[244] = new String[]{"&bdquo;", "&#8222;", "„"};
        entities[245] = new String[]{"&dagger;", "&#8224;", "†"};
        entities[246] = new String[]{"&Dagger;", "&#8225;", "‡"};
        entities[247] = new String[]{"&permil;", "&#8240;", "‰"};
        entities[248] = new String[]{"&lsaquo;", "&#8249;", "‹"};
        entities[249] = new String[]{"&rsaquo;", "&#8250;", "›"};
        entities[CameraAnimator.DEFAULT_DURATION] = new String[]{"&euro;", "&#8364;", "€"};
