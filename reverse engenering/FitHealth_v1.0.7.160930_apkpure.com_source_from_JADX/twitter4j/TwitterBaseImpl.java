...
abstract class TwitterBaseImpl implements TwitterBase, Serializable, OAuthSupport, OAuth2Support, HttpResponseListener {
    ...
    User fillInIDAndScreenName() throws TwitterException {
        ...
        User user = new UserJSONImpl(this.http.get(this.conf.getRestBaseURL() + "account/verify_credentials.json", null, this.auth, this), this.conf);
    ...
    public void httpResponseReceived(HttpResponseEvent event) {
        if (this.rateLimitStatusListeners.size() != 0) {
            ...
            if (rateLimitStatus != null) {
                ...
                if (statusCode == 420 || statusCode == 503 || statusCode == HttpResponseCode.TOO_MANY_REQUESTS) {
