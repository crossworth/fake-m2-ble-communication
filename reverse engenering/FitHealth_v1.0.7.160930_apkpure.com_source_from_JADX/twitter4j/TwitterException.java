...
public class TwitterException extends Exception implements TwitterResponse, HttpResponseCode {
    ...
    public String getResponseHeader(String name) {
        ...
        List<String> header = (List) this.response.getResponseHeaderFields().get(name);
        if (header.size() > 0) {
    ...
    public int getRetryAfter() {
        if (this.statusCode == 400) {
            ...
            try {
                String retryAfterStr = this.response.getResponseHeader(HttpHeaders.RETRY_AFTER);
    ...
    public boolean exceededRateLimitation() {
        return (this.statusCode == 400 && getRateLimitStatus() != null) || this.statusCode == 420 || this.statusCode == HttpResponseCode.TOO_MANY_REQUESTS;
    }
