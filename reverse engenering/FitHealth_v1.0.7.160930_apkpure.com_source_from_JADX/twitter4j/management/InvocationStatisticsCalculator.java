...
public class InvocationStatisticsCalculator implements InvocationStatistics {
    ...
    public String toString() {
        ...
        sb.append("calls=").append(getCallCount()).append(SeparatorConstants.SEPARATOR_ADS_ID).append("errors=").append(getErrorCount()).append(SeparatorConstants.SEPARATOR_ADS_ID).append("totalTime=").append(getTotalTime()).append(SeparatorConstants.SEPARATOR_ADS_ID).append("avgTime=").append(getAverageTime());
        return sb.toString();
    }
}
