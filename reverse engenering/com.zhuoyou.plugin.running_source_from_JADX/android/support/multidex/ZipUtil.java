    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile raf) throws IOException, ZipException {
        ...
        do {
            ...
            if (raf.readInt() == endSig) {
                ...
                dir.size = ((long) Integer.reverseBytes(raf.readInt())) & DataConstants.UNSIGNED_INT_MAX_VALUE;
                dir.offset = ((long) Integer.reverseBytes(raf.readInt())) & DataConstants.UNSIGNED_INT_MAX_VALUE;
                return dir;
            }
            scanOffset--;
