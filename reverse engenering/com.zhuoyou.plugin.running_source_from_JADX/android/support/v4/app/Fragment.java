...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00131 extends FragmentContainer {
        C00131() {
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C00141();
        final Bundle mState;

        static class C00141 implements Creator<SavedState> {
            C00141() {
            }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C00131(), this);
    }
