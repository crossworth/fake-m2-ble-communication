...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00322();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00311();
    ...
    class C00322 implements OnItemClickListener {
        C00322() {
        }
