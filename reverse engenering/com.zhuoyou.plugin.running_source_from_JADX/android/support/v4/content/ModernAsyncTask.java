...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00391();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00402();

    static class C00391 implements ThreadFactory {
    ...
    class C00402 extends WorkerRunnable<Params, Result> {
        C00402() {
            super();
        }
