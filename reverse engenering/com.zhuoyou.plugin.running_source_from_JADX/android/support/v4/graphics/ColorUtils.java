...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, to = 255) int r, @IntRange(from = 0, to = 255) int g, @IntRange(from = 0, to = 255) int b, @NonNull float[] outHsl) {
        float s;
        float h;
        float rf = ((float) r) / ColorConstants.COLOR_FACTOR_INT_TO_FLOAT;
        float gf = ((float) g) / ColorConstants.COLOR_FACTOR_INT_TO_FLOAT;
        float bf = ((float) b) / ColorConstants.COLOR_FACTOR_INT_TO_FLOAT;
    ...
    public static int HSLToColor(@NonNull float[] hsl) {
        ...
        switch (((int) h) / 60) {
            case 0:
                r = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (c + m));
                g = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (x + m));
                b = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * m);
                break;
            case 1:
                r = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (x + m));
                g = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (c + m));
                b = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * m);
                break;
            case 2:
                r = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * m);
                g = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (c + m));
                b = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (x + m));
                break;
            case 3:
                r = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * m);
                g = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (x + m));
                b = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (c + m));
                break;
            case 4:
                r = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (x + m));
                g = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * m);
                b = Math.round(ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * (c + m));
                break;
            case 5:
            case 6:
    ...
    public static void blendLAB(@NonNull double[] lab1, @NonNull double[] lab2, @FloatRange(from = 0.0d, to = 1.0d) double ratio, @NonNull double[] outResult) {
        ...
        double inverseRatio = WeightedLatLng.DEFAULT_INTENSITY - ratio;
