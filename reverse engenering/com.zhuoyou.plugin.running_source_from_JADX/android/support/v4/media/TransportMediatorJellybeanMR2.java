...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00774();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00785();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00763();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00796();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00741();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00752();

    class C00741 implements OnWindowAttachListener {
        C00741() {
        }
    ...
    class C00752 implements OnWindowFocusChangeListener {
        C00752() {
        }
    ...
    class C00763 extends BroadcastReceiver {
        C00763() {
        }
    ...
    class C00774 implements OnAudioFocusChangeListener {
        C00774() {
        }
    ...
    class C00785 implements OnGetPlaybackPositionListener {
        C00785() {
        }
    ...
    class C00796 implements OnPlaybackPositionUpdateListener {
        C00796() {
        }
