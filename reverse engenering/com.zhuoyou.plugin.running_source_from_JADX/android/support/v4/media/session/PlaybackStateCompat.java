...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00901();
    ...
    static class C00901 implements Creator<PlaybackStateCompat> {
        C00901() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00911();
        ...
        static class C00911 implements Creator<CustomAction> {
            C00911() {
            }
