...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01181();
    ...
    private static final Interpolator sInterpolator = new C01192();
    ...
    private final Runnable mEndScrollRunnable = new C01203();
    ...
    static class C01181 implements Comparator<ItemInfo> {
        C01181() {
        }
    ...
    class C01214 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C01221());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C01221 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01221() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01214());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), DataConstants.BYTES_PER_GIGABYTE), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, DataConstants.BYTES_PER_GIGABYTE));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
