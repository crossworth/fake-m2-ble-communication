...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01521 implements AnimationListener {
        C01521() {
        }
    ...
    class C01532 extends Animation {
        C01532() {
        }
    ...
    class C01543 extends Animation {
        C01543() {
        }
    ...
    class C01565 implements AnimationListener {
        C01565() {
        }
    ...
    class C01576 extends Animation {
        C01576() {
        }
    ...
    class C01587 extends Animation {
        C01587() {
        }
    ...
    class C01598 extends Animation {
        C01598() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01521();
        this.mAnimateToCorrectPosition = new C01576();
        this.mAnimateToStartPosition = new C01587();
    ...
    private void createProgressView() {
        this.mCircleView = new CircleImageView(getContext(), CIRCLE_BG_LIGHT, TitleBar.BACKBTN_LEFT_MARGIN);
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01532();
    ...
    private void setAnimationProgress(float progress) {
        if (isAlphaUsedForScale()) {
            setColorViewAlpha((int) (ColorConstants.COLOR_FACTOR_INT_TO_FLOAT * progress));
            return;
        }
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01543();
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTarget != null) {
            this.mTarget.measure(MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), DataConstants.BYTES_PER_GIGABYTE));
            this.mCircleView.measure(MeasureSpec.makeMeasureSpec(this.mCircleWidth, DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec(this.mCircleHeight, DataConstants.BYTES_PER_GIGABYTE));
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01598();
