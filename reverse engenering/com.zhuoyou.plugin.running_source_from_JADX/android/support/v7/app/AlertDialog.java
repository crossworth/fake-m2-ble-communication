...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder(Context context, int theme) {
            this.f5P = new AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, theme)));
            this.mTheme = theme;
        }
        ...
        public AlertDialog create() {
            AlertDialog dialog = new AlertDialog(this.f5P.mContext, this.mTheme, false);
    ...
    static int resolveDialogTheme(Context context, int resid) {
        ...
        context.getTheme().resolveAttribute(C0189R.attr.alertDialogTheme, outValue, true);
