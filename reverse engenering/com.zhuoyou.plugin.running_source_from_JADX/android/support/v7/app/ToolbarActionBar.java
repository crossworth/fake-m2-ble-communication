...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C01842();
    private final Runnable mMenuInvalidator = new C01831();
    ...
    class C01842 implements OnMenuItemClickListener {
        C01842() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0189R.layout.abc_list_menu_item_layout);
