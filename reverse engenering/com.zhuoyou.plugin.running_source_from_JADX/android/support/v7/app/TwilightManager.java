...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        if (PermissionChecker.checkSelfPermission(this.mContext, Permissions.PERMISSION_LOCATION) == 0) {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - LogBuilder.MAX_INTERVAL, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(LogBuilder.MAX_INTERVAL + now, location.getLatitude(), location.getLongitude());
