...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C01861();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C01872();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C01883();

    class C01861 extends ViewPropertyAnimatorListenerAdapter {
        C01861() {
        }
    ...
    class C01872 extends ViewPropertyAnimatorListenerAdapter {
        C01872() {
        }
    ...
    class C01883 implements ViewPropertyAnimatorUpdateListener {
        C01883() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0189R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0189R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0189R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0189R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0189R.styleable.ActionBar, C0189R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0189R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0189R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0189R.attr.actionBarWidgetTheme, outValue, true);
