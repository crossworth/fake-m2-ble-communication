...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C01922();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    private int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C01911();
    ...
    class C01911 implements MainThreadCallback<T> {
        C01911() {
        }
    ...
    class C01922 implements BackgroundCallback<T> {
