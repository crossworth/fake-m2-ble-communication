...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAllowTextWithIcon = res.getBoolean(C0189R.bool.abc_config_allowActionMenuItemTextWithIcon);
        TypedArray a = context.obtainStyledAttributes(attrs, C0189R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0189R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        this.mAllowTextWithIcon = getContext().getResources().getBoolean(C0189R.bool.abc_config_allowActionMenuItemTextWithIcon);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != DataConstants.BYTES_PER_GIGABYTE && this.mMinWidth > 0 && oldMeasuredWidth < targetWidth) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(targetWidth, DataConstants.BYTES_PER_GIGABYTE), heightMeasureSpec);
        }
