...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0189R.styleable.MenuView, defStyle, 0);
        this.mBackground = a.getDrawable(C0189R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0189R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0189R.styleable.MenuView_preserveIconSpacing, false);
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0189R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0189R.id.shortcut);
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0189R.layout.abc_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0189R.layout.abc_list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0189R.layout.abc_list_menu_item_checkbox, this, false);
