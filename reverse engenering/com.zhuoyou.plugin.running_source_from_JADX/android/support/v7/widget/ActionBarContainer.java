...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0189R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0189R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0189R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0189R.styleable.ActionBar_height, -1);
        if (getId() == C0189R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0189R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0189R.id.action_bar);
        this.mContextView = findViewById(C0189R.id.action_context_bar);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != DataConstants.BYTES_PER_GIGABYTE) {
