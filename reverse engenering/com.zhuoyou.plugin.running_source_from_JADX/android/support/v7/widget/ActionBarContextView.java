...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0189R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0189R.styleable.ActionMode, defStyle, 0);
        setBackgroundDrawable(a.getDrawable(C0189R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0189R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0189R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0189R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0189R.styleable.ActionMode_closeItemLayout, C0189R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0189R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0189R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0189R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                int customWidthMode = lp2.width != -2 ? DataConstants.BYTES_PER_GIGABYTE : Integer.MIN_VALUE;
                if (lp2.width >= 0) {
                    customWidth = Math.min(lp2.width, availableWidth);
                } else {
                    customWidth = availableWidth;
                }
                int customHeightMode = lp2.height != -2 ? DataConstants.BYTES_PER_GIGABYTE : Integer.MIN_VALUE;
                if (lp2.height >= 0) {
