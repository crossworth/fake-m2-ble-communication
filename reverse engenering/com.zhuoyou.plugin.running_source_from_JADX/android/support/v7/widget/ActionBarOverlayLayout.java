...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0189R.attr.actionBarSize, 16842841};
    ...
    class C02011 extends ViewPropertyAnimatorListenerAdapter {
        C02011() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02011();
        this.mRemoveActionBarHideOffset = new C02022();
        this.mAddActionBarHideOffset = new C02033();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0189R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0189R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0189R.id.action_bar));
        }
    }
