...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0189R.styleable.AppCompatImageView, defStyleAttr, 0);
        try {
            Drawable d = a.getDrawableIfKnown(C0189R.styleable.AppCompatImageView_android_src);
            if (d != null) {
                this.mView.setImageDrawable(d);
            }
            int id = a.getResourceId(C0189R.styleable.AppCompatImageView_srcCompat, -1);
            if (id != -1) {
