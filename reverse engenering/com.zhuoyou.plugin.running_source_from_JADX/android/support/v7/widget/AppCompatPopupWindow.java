...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0189R.styleable.PopupWindow, defStyleAttr, 0);
        if (a.hasValue(C0189R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0189R.styleable.PopupWindow_overlapAnchor, false));
        }
        setBackgroundDrawable(a.getDrawable(C0189R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
