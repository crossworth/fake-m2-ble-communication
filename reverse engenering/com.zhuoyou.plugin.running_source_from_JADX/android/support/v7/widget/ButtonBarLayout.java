...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0189R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0189R.styleable.ButtonBarLayout_allowStacking, false);
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isStacked() || MeasureSpec.getMode(widthMeasureSpec) != DataConstants.BYTES_PER_GIGABYTE) {
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0189R.id.spacer);
        if (spacer != null) {
