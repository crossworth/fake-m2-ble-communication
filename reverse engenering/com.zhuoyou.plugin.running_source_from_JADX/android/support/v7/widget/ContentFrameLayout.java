    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tvw == null || tvw.type == 0)) {
                ...
                if (w > 0) {
                    widthMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(w - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(widthMeasureSpec)), DataConstants.BYTES_PER_GIGABYTE);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (!(tvh == null || tvh.type == 0)) {
                ...
                if (h > 0) {
                    heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(h - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(heightMeasureSpec)), DataConstants.BYTES_PER_GIGABYTE);
                }
            }
        }
        ...
        widthMeasureSpec = MeasureSpec.makeMeasureSpec(width, DataConstants.BYTES_PER_GIGABYTE);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tv == null || tv.type == 0)) {
                ...
                if (width < min) {
                    widthMeasureSpec = MeasureSpec.makeMeasureSpec(min, DataConstants.BYTES_PER_GIGABYTE);
                    measure = true;
                }
            }
        }
