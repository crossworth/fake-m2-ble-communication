...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0189R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0189R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0189R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0189R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C0189R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        index = a.getInt(C0189R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index >= 0) {
            setGravity(index);
        }
        boolean baselineAligned = a.getBoolean(C0189R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0189R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0189R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0189R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0189R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0189R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0189R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == 1) {
                int majorGravity = this.mGravity & BtManagerService.CLASSIC_CMD_GET_STEP;
                if (majorGravity != 48) {
                    switch (majorGravity) {
                        case 16:
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp.height == 0 && heightMode == 1073741824) {
                            ...
                            child.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(share, DataConstants.BYTES_PER_GIGABYTE));
                        } else {
                            childHeight = child.getMeasuredHeight() + share;
                            if (childHeight < 0) {
                                childHeight = 0;
                            }
                            child.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(childHeight, DataConstants.BYTES_PER_GIGABYTE));
                        }
            ...
            if (useLargestChild && heightMode != 1073741824) {
                for (i = 0; i < count; i++) {
                    ...
                    if (!(child == null || child.getVisibility() == 8 || ((LayoutParams) child.getLayoutParams()).weight <= 0.0f)) {
                        child.measure(MeasureSpec.makeMeasureSpec(child.getMeasuredWidth(), DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec(largestChildHeight, DataConstants.BYTES_PER_GIGABYTE));
                    }
                }
            }
        }
    ...
    private void forceUniformWidth(int count, int heightMeasureSpec) {
        int uniformMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), DataConstants.BYTES_PER_GIGABYTE);
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i & BtManagerService.CLASSIC_CMD_GET_STEP) >> 4) & -2) >> 1;
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp.width == 0 && widthMode == 1073741824) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec(share, DataConstants.BYTES_PER_GIGABYTE), childHeightMeasureSpec);
                        } else {
                            childWidth = child.getMeasuredWidth() + share;
                            if (childWidth < 0) {
                                childWidth = 0;
                            }
                            child.measure(MeasureSpec.makeMeasureSpec(childWidth, DataConstants.BYTES_PER_GIGABYTE), childHeightMeasureSpec);
                        }
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i & BtManagerService.CLASSIC_CMD_GET_STEP) >> 4) & -2) >> 1;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (i2 = 0; i2 < count; i2++) {
                    child = getVirtualChildAt(i2);
                    if (!(child == null || child.getVisibility() == 8 || ((LayoutParams) child.getLayoutParams()).weight <= 0.0f)) {
                        child.measure(MeasureSpec.makeMeasureSpec(largestChildWidth, DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), DataConstants.BYTES_PER_GIGABYTE));
                    }
                }
            }
        }
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        int uniformMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight(), DataConstants.BYTES_PER_GIGABYTE);
        for (int i = 0; i < count; i++) {
            View child = getVirtualChildAt(i);
            if (child.getVisibility() != 8) {
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & BtManagerService.CLASSIC_CMD_GET_STEP;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & BtManagerService.CLASSIC_CMD_GET_STEP) {
                    case 16:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & BtManagerService.CLASSIC_CMD_GET_STEP) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & BtManagerService.CLASSIC_CMD_GET_STEP;
        if ((this.mGravity & BtManagerService.CLASSIC_CMD_GET_STEP) != gravity) {
