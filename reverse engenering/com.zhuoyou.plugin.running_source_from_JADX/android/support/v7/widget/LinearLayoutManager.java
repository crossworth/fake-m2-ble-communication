...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C02281();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        static class C02281 implements Creator<SavedState> {
            C02281() {
            }
    ...
    boolean shouldMeasureTwice() {
        return (getHeightMode() == DataConstants.BYTES_PER_GIGABYTE || getWidthMode() == DataConstants.BYTES_PER_GIGABYTE || !hasFlexibleChildInBothOrientations()) ? false : true;
    }
