...
public class ListPopupWindow {
    ...
    class C02313 implements OnItemSelectedListener {
        C02313() {
        }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0189R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0189R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0189R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0189R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02302();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02313());
        ...
        switch (this.mDropDownWidth) {
            case -2:
                ...
                break;
            case -1:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), DataConstants.BYTES_PER_GIGABYTE);
                break;
            default:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mDropDownWidth, DataConstants.BYTES_PER_GIGABYTE);
                break;
        }
