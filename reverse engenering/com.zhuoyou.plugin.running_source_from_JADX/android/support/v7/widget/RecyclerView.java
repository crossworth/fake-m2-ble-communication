...
import android.support.v7.recyclerview.C0190R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static final Interpolator sQuinticInterpolator = new C02373();
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = DataConstants.BYTES_PER_GIGABYTE;
            this.mHeightMode = DataConstants.BYTES_PER_GIGABYTE;
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = DataConstants.BYTES_PER_GIGABYTE;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == Integer.MIN_VALUE || parentMode == DataConstants.BYTES_PER_GIGABYTE) ? Integer.MIN_VALUE : 0;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0190R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0190R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0190R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0190R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0190R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), DataConstants.BYTES_PER_GIGABYTE));
        }
    ...
    static class C02373 implements Interpolator {
        C02373() {
        }
    ...
    class C02384 implements ProcessCallback {
        C02384() {
        }
    ...
    class C02395 implements Callback {
        C02395() {
        }
    ...
    class C02406 implements Callback {
        C02406() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C02411();
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02351();
        ...
        this.mItemAnimatorRunner = new C02362();
        this.mViewInfoProcessCallback = new C02384();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0190R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0190R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C02395());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C02406());
    }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (this.mLayout == null) {
            ...
            if (widthMode == DataConstants.BYTES_PER_GIGABYTE && heightMode == DataConstants.BYTES_PER_GIGABYTE) {
                skipMeasure = true;
            }
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), DataConstants.BYTES_PER_GIGABYTE), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), DataConstants.BYTES_PER_GIGABYTE));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
