...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02474 implements OnFocusChangeListener {
        C02474() {
        }
    ...
    class C02485 implements OnLayoutChangeListener {
        C02485() {
        }
    ...
    class C02496 implements OnGlobalLayoutListener {
        C02496() {
        }
    ...
    class C02518 implements OnKeyListener {
        C02518() {
        }
    ...
    class C02529 implements OnEditorActionListener {
        C02529() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C02531();
        boolean isIconified;

        static class C02531 implements Creator<SavedState> {
            C02531() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0189R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0189R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C02441();
        this.mUpdateDrawableStateRunnable = new C02452();
        this.mReleaseCursorRunnable = new C02463();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02507();
        this.mTextKeyListener = new C02518();
        this.mOnEditorActionListener = new C02529();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0189R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0189R.styleable.SearchView_layout, C0189R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0189R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0189R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0189R.id.search_plate);
        this.mSubmitArea = findViewById(C0189R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0189R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0189R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0189R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0189R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0189R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0189R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0189R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0189R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0189R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0189R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0189R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0189R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0189R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0189R.styleable.SearchView_suggestionRowLayout, C0189R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0189R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02474());
        setIconifiedByDefault(a.getBoolean(C0189R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0189R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0189R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0189R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0189R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0189R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0189R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02485());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02496());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(width, DataConstants.BYTES_PER_GIGABYTE), heightMeasureSpec);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0189R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0189R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, DataConstants.BYTES_PER_GIGABYTE);
