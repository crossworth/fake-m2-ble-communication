...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new C02551();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C02571();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class C02571 implements Creator<FullSpanItem> {
                C02571() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C02581();
        ...
        static class C02581 implements Creator<SavedState> {
            C02581() {
            }
    ...
    private void repositionToWrapContentIfNecessary() {
        if (this.mSecondaryOrientation.getMode() != DataConstants.BYTES_PER_GIGABYTE) {
            int i;
            View child;
            float maxSize = 0.0f;
    ...
    private int updateSpecWithExtra(int spec, int startInset, int endInset) {
        ...
        if (mode == Integer.MIN_VALUE || mode == DataConstants.BYTES_PER_GIGABYTE) {
