...
public class Toolbar extends ViewGroup {
    ...
    class C02601 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02601() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & BtManagerService.CLASSIC_CMD_GET_STEP);
                lp.mViewType = 2;
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C02631();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C02631 implements Creator<SavedState> {
            C02631() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0189R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C02601();
        this.mShowOverflowMenuRunnable = new C02612();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0189R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0189R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0189R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0189R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = 48;
        int dimensionPixelOffset = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_titleMargins, 0);
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        int marginStart = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0189R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0189R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        this.mContentInsets.setAbsolute(a.getDimensionPixelSize(C0189R.styleable.Toolbar_contentInsetLeft, 0), a.getDimensionPixelSize(C0189R.styleable.Toolbar_contentInsetRight, 0));
        ...
        this.mCollapseIcon = a.getDrawable(C0189R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0189R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0189R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0189R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0189R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0189R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0189R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C0189R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C0189R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0189R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(a.getColor(C0189R.styleable.Toolbar_titleTextColor, -1));
        }
        if (a.hasValue(C0189R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0189R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = GravityCompat.END | (this.mButtonGravity & BtManagerService.CLASSIC_CMD_GET_STEP);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new ImageButton(getContext(), null, C0189R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (this.mButtonGravity & BtManagerService.CLASSIC_CMD_GET_STEP);
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new ImageButton(getContext(), null, C0189R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C02623());
        }
    }
    ...
    private void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        ...
        if (childHeightMode != DataConstants.BYTES_PER_GIGABYTE && heightConstraint >= 0) {
            childHeightSpec = MeasureSpec.makeMeasureSpec(childHeightMode != 0 ? Math.min(MeasureSpec.getSize(childHeightSpec), heightConstraint) : heightConstraint, DataConstants.BYTES_PER_GIGABYTE);
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            switch (this.mGravity & BtManagerService.CLASSIC_CMD_GET_STEP) {
                case 48:
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & BtManagerService.CLASSIC_CMD_GET_STEP;
        switch (vgrav) {
            case 16:
            case 48:
            case 80:
                return vgrav;
            default:
                return this.mGravity & BtManagerService.CLASSIC_CMD_GET_STEP;
        }
    }
