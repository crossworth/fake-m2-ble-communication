        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    _result = showCallScreenWithDialpad(_arg0);
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result3 = getCellLocation();
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                    List<NeighboringCellInfo> _result4 = getNeighboringCellInfo();
                    reply.writeNoException();
                    reply.writeTypedList(_result4);
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getCallState();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 29:
                ...
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getActivePhoneType();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getCdmaEriIconIndex();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getCdmaEriIconMode();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    String _result5 = getCdmaEriText();
                    reply.writeNoException();
                    reply.writeString(_result5);
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getCdmaNeedsProvisioning();
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getVoiceMessageCount();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getNetworkType();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 38:
