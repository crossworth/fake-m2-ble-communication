        ...
        if (request.shouldCache()) {
            synchronized (this.mWaitingRequests) {
                ...
                if (this.mWaitingRequests.containsKey(cacheKey)) {
                    ...
                    if (VolleyLog.DEBUG) {
                        VolleyLog.m49v("Request for cacheKey=%s is in flight, putting on hold.", cacheKey);
                    }
                } else {
        ...
        if (request.shouldCache()) {
            synchronized (this.mWaitingRequests) {
                ...
                if (waitingRequests != null) {
                    if (VolleyLog.DEBUG) {
                        VolleyLog.m49v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(waitingRequests.size()), cacheKey);
                    }
