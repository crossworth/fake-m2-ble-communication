...
public class VolleyLog {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String header) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m46d("(%-4d ms) %s", Long.valueOf(duration), header);
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m46d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - prevTime), Long.valueOf(marker.thread), marker.name);
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m47e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    ...
    public static void setTag(String tag) {
        m46d("Changing log tag to %s", tag);
        TAG = tag;
        DEBUG = Log.isLoggable(TAG, 2);
    }

    public static void m49v(String format, Object... args) {
        if (DEBUG) {
            Log.v(TAG, buildMessage(format, args));
        }
    }

    public static void m46d(String format, Object... args) {
        Log.d(TAG, buildMessage(format, args));
    }

    public static void m47e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    public static void m48e(Throwable tr, String format, Object... args) {
