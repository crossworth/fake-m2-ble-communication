...
public class ImageLoader {
    ...
    class C02871 implements ImageListener {
        ...
        C02871(int i, ImageView imageView, int i2) {
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C02871(errorImageResId, view, defaultImageResId);
    }
