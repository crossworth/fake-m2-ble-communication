...
public final class C0467i {
    public static String f869a = (C0467i.m1003a().m1007b() + "/baidu/tempdata");
    private static volatile C0467i f870c = null;
    private final List<C0466h> f871b = new ArrayList();
    private Context f872d;

    private C0467i(Context context) {
        this.f872d = context;
    }

    public static C0467i m1003a() {
        if (f870c == null) {
            synchronized (C0467i.class) {
                if (f870c == null) {
                    f870c = new C0467i(C0455f.getServiceContext());
                }
            }
        }
        return f870c;
    ...
    private boolean m1004a(String str) {
    ...
    @SuppressLint({"NewApi"})
    @TargetApi(14)
    private List<C0466h> m1005d() {
        try {
            StorageManager storageManager = (StorageManager) this.f872d.getSystemService("storage");
                ...
                for (Object obj : objArr) {
                    ...
                    if (str != null && str.length() > 0) {
                        if ("mounted".equals(method2.invoke(storageManager, new Object[]{str}))) {
                            ...
                            if (VERSION.SDK_INT <= 19 && m1004a(str)) {
                                this.f871b.add(new C0466h(str, obj2 == null, obj2 != null ? "Internal Storage" : "External Storage"));
                            }
                        }
                    }
                }
                if (VERSION.SDK_INT >= 19) {
                    File[] externalFilesDirs = this.f872d.getExternalFilesDirs(null);
                    Collection arrayList = new ArrayList();
                    arrayList.addAll(this.f871b);
                    int i = 0;
                    while (i < externalFilesDirs.length && externalFilesDirs[i] != null) {
                        Object obj3;
                        String absolutePath = externalFilesDirs[i].getAbsolutePath();
                        for (C0466h a : this.f871b) {
                            if (absolutePath.startsWith(a.m1002a())) {
                                obj3 = 1;
                                break;
                            }
                        }
                        obj3 = null;
                        if (obj3 == null && absolutePath.indexOf(this.f872d.getPackageName()) != -1) {
                            arrayList.add(new C0466h(absolutePath, true, "External Storage"));
                        }
                        i++;
                    }
                    this.f871b.clear();
                    this.f871b.addAll(arrayList);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private java.util.List<com.baidu.location.p006h.C0466h> m1006e() {
        /*
        r9 = this;
        r2 = 0;
    ...
    L_0x00b4:
        ...
        r0 = r9.f871b;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r5 = new com.baidu.location.h.h;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r6 = 0;
        r7 = "Auto";
    ...
    L_0x00f6:
        ...
        if (r5 == 0) goto L_0x00cd;
    L_0x00fc:
        r5 = r9.f871b;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r6 = new com.baidu.location.h.h;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r7 = 0;
        r8 = "Auto";
    ...
    L_0x011a:
        ...
        goto L_0x00ab;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.h.i.e():java.util.List<com.baidu.location.h.h>");
    }

    public String m1007b() {
        List c = m1008c();
        return (c == null || c.size() == 0) ? null : ((C0466h) c.get(0)).m1002a();
    }

    public List<C0466h> m1008c() {
        List<C0466h> list = null;
        if (VERSION.SDK_INT >= 14) {
            list = m1005d();
        }
        return (list == null || list.size() <= 0) ? m1006e() : list;
    }
}
