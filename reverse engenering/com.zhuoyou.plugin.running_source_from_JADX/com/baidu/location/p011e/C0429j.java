...
final class C0429j {
    private static final String[] f695a = new String[]{"CoorType", "Time", "LocType", "Longitude", "Latitude", "Radius", "NetworkLocationType", "Country", "CountryCode", "Province", "City", "CityCode", "District", "Street", "StreetNumber", "PoiList", "LocationDescription"};
    ...
    static final class C0428a {
        ...
        final boolean f690e;
        final int f691f;
        final BDLocation f692g;
        final boolean f693h;
        final LinkedHashMap<String, Integer> f694i;

        public C0428a(String[] strArr) {
            if (strArr == null) {
                this.f686a = null;
                this.f687b = null;
                this.f694i = null;
            ...
            while (i < strArr.length) {
                if (strArr[i].equals("-loc")) {
                    ...
                    if (strArr[i + 1].equals(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE)) {
                        obj = 1;
                    }
                    ...
                    try {
                        if (strArr[i].equals("-des") && strArr[i + 1].equals(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE)) {
                            z = true;
                        }
                    } catch (Exception e3) {
                    }
            ...
            this.f686a = str2;
            this.f687b = str;
            this.f694i = linkedHashMap;
            this.f688c = z4;
            this.f689d = z3;
            this.f690e = z2;
            this.f691f = i2;
            this.f692g = bDLocation;
            this.f693h = z;
            z4 = false;
            this.f686a = str2;
            this.f687b = str;
    ...
    static Cursor m792a(BDLocation bDLocation) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        Object matrixCursor = new MatrixCursor(f695a);
        Object[] objArr = new Object[f695a.length];
    ...
    static BDLocation m793a(Cursor cursor) {
    ...
    static String m794a(BDLocation bDLocation, int i) {
        ...
        if (C0459b.f835d == null) {
            return str;
        }
        return str + String.format(Locale.US, "&pack=%s&sdk=%.3f", new Object[]{C0459b.f835d, Float.valueOf(7.01f)});
    }

    static String m795a(BDLocation bDLocation, BDLocation bDLocation2, C0428a c0428a) {
        StringBuffer stringBuffer = new StringBuffer();
        if (bDLocation2 == null) {
        ...
        if (c0428a == null || !c0428a.f690e) {
            stringBuffer.append("&rgcn=0");
        } else {
            stringBuffer.append("&rgcn=1");
        }
        if (c0428a == null || !c0428a.f689d) {
            stringBuffer.append("&poin=0");
        } else {
            stringBuffer.append("&poin=1");
        }
        if (c0428a == null || !c0428a.f693h) {
            stringBuffer.append("&desc=0");
        } else {
            stringBuffer.append("&desc=1");
        }
        if (c0428a != null) {
            stringBuffer.append(String.format(Locale.US, "&aps=%d", new Object[]{Integer.valueOf(c0428a.f691f)}));
        }
        return stringBuffer.toString();
    }

    static String[] m796a(C0441a c0441a, C0451g c0451g, BDLocation bDLocation, String str, boolean z, int i) {
        ArrayList arrayList = new ArrayList();
        StringBuffer stringBuffer = new StringBuffer();
        if (c0441a != null) {
            stringBuffer.append(C0443b.m855a().m868b(c0441a));
        }
        if (c0451g != null) {
            stringBuffer.append(c0451g.m934a(30));
        }
