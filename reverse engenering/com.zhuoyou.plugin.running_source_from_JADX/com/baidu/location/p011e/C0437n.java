...
import com.baidu.location.p011e.C0436m.C0435b;
...
enum C0437n extends C0435b {
    C0437n(String str, int i, String str2, String str3, String str4, int i2, int i3) {
        super(str, i, str2, str3, str4, i2, i3);
    }

    List<String> mo1750a(JSONObject jSONObject, String str, int i) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                ...
                C0435b.m820b(stringBuffer2, str8, str, 0);
