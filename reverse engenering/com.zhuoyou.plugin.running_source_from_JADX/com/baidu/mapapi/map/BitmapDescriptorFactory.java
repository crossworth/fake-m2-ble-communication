...
public class BitmapDescriptorFactory {
    static final /* synthetic */ boolean f1055a = (!BitmapDescriptorFactory.class.desiredAssertionStatus());
    ...
    public static BitmapDescriptor fromAsset(String str) {
        ...
        try {
            ...
            BitmapDescriptor fromBitmap = fromBitmap(loadAssetsFile);
            if (f1055a || loadAssetsFile != null) {
                loadAssetsFile.recycle();
                return fromBitmap;
            }
    ...
    public static BitmapDescriptor fromAssetWithDpi(String str) {
        ...
        try {
            ...
            if (densityDpi > 480) {
                ...
                createBitmap = Bitmap.createBitmap(loadAssetsFile, 0, 0, loadAssetsFile.getWidth(), loadAssetsFile.getHeight(), matrix, true);
                fromBitmap = fromBitmap(createBitmap);
            } else if (densityDpi <= 320 || densityDpi > 480) {
                fromBitmap = fromBitmap(loadAssetsFile);
                createBitmap = null;
            } else {
                matrix = new Matrix();
