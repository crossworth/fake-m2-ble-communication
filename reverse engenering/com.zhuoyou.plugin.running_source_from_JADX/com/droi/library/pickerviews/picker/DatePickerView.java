...
public class DatePickerView extends LinearLayout implements IPickerView {
    ...
    private static String[] months_big = new String[]{"1", "3", "5", Constants.VIA_SHARE_TYPE_PUBLISHMOOD, Constants.VIA_SHARE_TYPE_PUBLISHVIDEO, Constants.VIA_REPORT_TYPE_SHARE_TO_QQ, Constants.VIA_REPORT_TYPE_SET_AVATAR};
    private static String[] months_little = new String[]{"4", Constants.VIA_SHARE_TYPE_INFO, "9", Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE};
    ...
    private int minYear = f_FUN.FUN_ID_VOICE_SCH;
    ...
    class C07421 implements OnItemSelectedListener {
        C07421() {
        }
    ...
    class C07432 implements OnItemSelectedListener {
        C07432() {
        }
    ...
    class C07443 implements OnItemSelectedListener {
        C07443() {
        }
    ...
    private void initView(Context context) {
        View contentView = LayoutInflater.from(context).inflate(C0738R.layout.date_picker_layout, this, true);
        this.yearView = (WheelView) contentView.findViewById(C0738R.id.year_view);
        this.monthView = (WheelView) contentView.findViewById(C0738R.id.month_view);
        this.dayView = (WheelView) contentView.findViewById(C0738R.id.day_view);
        this.yearView.setOnItemSelectedListener(new C07421());
        this.monthView.setOnItemSelectedListener(new C07432());
        this.dayView.setOnItemSelectedListener(new C07443());
    }
    ...
    public void showLabel(boolean show) {
        if (show) {
            this.yearView.setLabel(C0738R.string.pickerview_year);
            this.monthView.setLabel(C0738R.string.pickerview_month);
            this.dayView.setLabel(C0738R.string.pickerview_day);
            return;
        }
    ...
    private void initDayView() {
        ...
        } else if (((this.yearIndex + this.minYear) % 4 != 0 || (this.yearIndex + this.minYear) % 100 == 0) && (this.yearIndex + this.minYear) % HttpResponseCode.BAD_REQUEST != 0) {
