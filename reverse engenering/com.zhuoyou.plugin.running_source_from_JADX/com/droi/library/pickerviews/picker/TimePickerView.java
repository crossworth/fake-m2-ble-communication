...
public class TimePickerView extends LinearLayout implements IPickerView {
    ...
    class C07481 implements OnItemSelectedListener {
        C07481() {
        }
    ...
    class C07492 implements OnItemSelectedListener {
        C07492() {
        }
    ...
    private void initView(Context context) {
        View contentView = LayoutInflater.from(context).inflate(C0738R.layout.time_picker_layout, this, true);
        this.hourView = (WheelView) contentView.findViewById(C0738R.id.hour_view);
        this.minuteView = (WheelView) contentView.findViewById(C0738R.id.minute_view);
        this.hourView.setOnItemSelectedListener(new C07481());
        this.minuteView.setOnItemSelectedListener(new C07492());
    }
    ...
    public void showLabel(boolean show) {
        if (show) {
            this.hourView.setLabel(C0738R.string.pickerview_hours);
            this.minuteView.setLabel(C0738R.string.pickerview_minutes);
            return;
        }
