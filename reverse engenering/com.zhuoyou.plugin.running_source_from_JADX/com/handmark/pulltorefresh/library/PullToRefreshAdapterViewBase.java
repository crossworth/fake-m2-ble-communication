...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
    ...
    protected void handleStyledAttributes(TypedArray a) {
        this.mShowIndicator = a.getBoolean(C1064R.styleable.PullToRefresh_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
    }
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && this.mIndicatorIvTop == null) {
            ...
            params.rightMargin = getResources().getDimensionPixelSize(C1064R.dimen.indicator_right_padding);
            params.gravity = 53;
