...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
    ...
    public IndicatorLayout(Context context, Mode mode) {
        ...
        Drawable arrowD = getResources().getDrawable(C1064R.drawable.indicator_arrow);
        this.mArrowImageView.setImageDrawable(arrowD);
        int padding = getResources().getDimensionPixelSize(C1064R.dimen.indicator_internal_padding);
        this.mArrowImageView.setPadding(padding, padding, padding, padding);
        addView(this.mArrowImageView);
        switch (mode) {
            case PULL_FROM_END:
                inAnimResId = C1064R.anim.slide_in_from_bottom;
                outAnimResId = C1064R.anim.slide_out_to_bottom;
                setBackgroundResource(C1064R.drawable.indicator_bg_bottom);
                ...
                break;
            default:
                inAnimResId = C1064R.anim.slide_in_from_top;
                outAnimResId = C1064R.anim.slide_out_to_top;
                setBackgroundResource(C1064R.drawable.indicator_bg_top);
                break;
        }
