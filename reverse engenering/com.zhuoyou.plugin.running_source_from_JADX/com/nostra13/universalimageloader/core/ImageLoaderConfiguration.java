...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        public Builder taskExecutor(Executor executor) {
            if (!(this.threadPoolSize == 3 && this.threadPriority == 3 && this.tasksProcessingType == DEFAULT_TASK_PROCESSING_TYPE)) {
                C1100L.m3306w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
        ...
        public Builder memoryCacheSize(int memoryCacheSize) {
            ...
            if (this.memoryCache != null) {
                C1100L.m3306w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
            }
        ...
        public Builder diskCacheSize(int maxCacheSize) {
            ...
            if (this.diskCache != null) {
                C1100L.m3306w(WARNING_OVERLAP_DISK_CACHE_PARAMS, new Object[0]);
            }
        ...
        public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
            if (this.diskCache != null) {
                C1100L.m3306w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR, new Object[0]);
            }
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        C1100L.writeDebugLogs(builder.writeLogs);
    }
