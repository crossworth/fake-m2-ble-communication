...
public class BaseImageDecoder implements ImageDecoder {
    ...
    public Bitmap decode(ImageDecodingInfo decodingInfo) throws IOException {
        ...
        if (imageStream == null) {
            C1100L.m3302e(ERROR_NO_IMAGE_STREAM, decodingInfo.getImageKey());
            return bitmap;
        }
        try {
            ...
            C1100L.m3302e(ERROR_CANT_DECODE_IMAGE, decodingInfo.getImageKey());
            return bitmap;
        } finally {
    ...
    L_0x002d:
        ...
        r7 = 0;
        r6[r7] = r9;
        com.nostra13.universalimageloader.utils.C1100L.m3306w(r5, r6);
        goto L_0x0018;
        */
    ...
    protected Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo decodingInfo) {
        ...
        if (scale > 1 && this.loggingEnabled) {
            C1100L.m3301d(LOG_SUBSAMPLE_IMAGE, imageSize, imageSize.scaleDown(scale), Integer.valueOf(scale), decodingInfo.getImageKey());
        }
        ...
        if (scaleType == ImageScaleType.EXACTLY || scaleType == ImageScaleType.EXACTLY_STRETCHED) {
            ...
            if (Float.compare(scale, 1.0f) != 0) {
                ...
                if (this.loggingEnabled) {
                    C1100L.m3301d(LOG_SCALE_IMAGE, srcSize, srcSize.scale(scale), Float.valueOf(scale), decodingInfo.getImageKey());
                }
            }
        }
        if (flipHorizontal) {
            ...
            if (this.loggingEnabled) {
                C1100L.m3301d(LOG_FLIP_IMAGE, decodingInfo.getImageKey());
            }
        }
        if (rotation != 0) {
            m.postRotate((float) rotation);
            if (this.loggingEnabled) {
                C1100L.m3301d(LOG_ROTATE_IMAGE, Integer.valueOf(rotation), decodingInfo.getImageKey());
            }
        }
