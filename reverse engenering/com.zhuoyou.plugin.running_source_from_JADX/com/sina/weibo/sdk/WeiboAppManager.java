...
*/
    ...
    L_0x005b:
        ...
        com.sina.weibo.sdk.utils.LogUtil.m3308e(r1, r2);	 Catch:{ Exception -> 0x005b, all -> 0x006d }
    ...
    public WeiboInfo parseWeiboInfoByAsset(String packageName) {
        ...
        try {
            ...
            LogUtil.m3308e(TAG, e3.getMessage());
            if (is != null) {
                try {
                    is.close();
                } catch (IOException e22) {
                    LogUtil.m3308e(TAG, e22.getMessage());
                }
            }
        } catch (IOException e222) {
            LogUtil.m3308e(TAG, e222.getMessage());
            if (is != null) {
                try {
                    is.close();
                } catch (IOException e2222) {
                    LogUtil.m3308e(TAG, e2222.getMessage());
                }
            }
        } catch (JSONException e4) {
            LogUtil.m3308e(TAG, e4.getMessage());
            if (is != null) {
                try {
                    is.close();
                } catch (IOException e22222) {
                    LogUtil.m3308e(TAG, e22222.getMessage());
                }
            }
        } catch (Exception e5) {
            LogUtil.m3308e(TAG, e5.getMessage());
            if (is != null) {
                try {
                    is.close();
                } catch (IOException e222222) {
                    LogUtil.m3308e(TAG, e222222.getMessage());
                }
            }
        } catch (Throwable th) {
            if (is != null) {
                try {
                    ...
                    LogUtil.m3308e(TAG, e2222222.getMessage());
                }
            }
        }
        return null;
