...
public class ImageObject extends BaseMediaObject {
    public static final Creator<ImageObject> CREATOR = new C11031();
    private static final int DATA_SIZE = 2097152;
    public byte[] imageData;
    public String imagePath;

    class C11031 implements Creator<ImageObject> {
        C11031() {
        }
    ...
    public final void setImageObject(Bitmap bitmap) {
        ...
        try {
            ...
            try {
                ...
                try {
                    e.printStackTrace();
                    LogUtil.m3308e("Weibo.ImageObject", "put thumb failed");
                    if (os != null) {
                        try {
                            os.close();
    ...
    public boolean checkArgs() {
        if (this.imageData == null && this.imagePath == null) {
            LogUtil.m3308e("Weibo.ImageObject", "imageData and imagePath are null");
            return false;
        } else if (this.imageData != null && this.imageData.length > 2097152) {
            LogUtil.m3308e("Weibo.ImageObject", "imageData is too large");
            return false;
        } else if (this.imagePath == null || this.imagePath.length() <= 512) {
            if (this.imagePath != null) {
                File file = new File(this.imagePath);
                try {
                    if (!file.exists() || file.length() == 0 || file.length() > FileDescriptorHelper.f2835a) {
                        LogUtil.m3308e("Weibo.ImageObject", "checkArgs fail, image content is too large or not exists");
                        return false;
                    }
            ...
            LogUtil.m3308e("Weibo.ImageObject", "imagePath is too length");
            return false;
        }
    }
