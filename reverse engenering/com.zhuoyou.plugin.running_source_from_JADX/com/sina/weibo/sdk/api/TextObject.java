...
public class TextObject extends BaseMediaObject {
    public static final Creator<TextObject> CREATOR = new C11051();
    public String text;

    class C11051 implements Creator<TextObject> {
        C11051() {
        }
    ...
    public boolean checkArgs() {
        ...
        LogUtil.m3308e("Weibo.TextObject", "checkArgs fail, text is invalid");
        return false;
    }
