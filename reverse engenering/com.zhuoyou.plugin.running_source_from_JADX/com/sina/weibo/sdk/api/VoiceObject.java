...
public class VoiceObject extends BaseMediaObject {
    public static final Creator<VoiceObject> CREATOR = new C11071();
    ...
    class C11071 implements Creator<VoiceObject> {
        C11071() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            LogUtil.m3308e("Weibo.VoiceObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            LogUtil.m3308e("Weibo.VoiceObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            LogUtil.m3308e("Weibo.VoiceObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
