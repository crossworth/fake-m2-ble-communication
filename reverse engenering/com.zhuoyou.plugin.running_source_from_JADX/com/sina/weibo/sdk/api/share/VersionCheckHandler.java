...
public class VersionCheckHandler implements IVersionCheckHandler {
    ...
    public boolean checkRequest(Context context, WeiboInfo weiboInfo, WeiboMessage message) {
        ...
        LogUtil.m3307d(TAG, "WeiboMessage WeiboInfo package : " + weiboInfo.getPackageName());
        LogUtil.m3307d(TAG, "WeiboMessage WeiboInfo supportApi : " + weiboInfo.getSupportApi());
    ...
    public boolean checkRequest(Context context, WeiboInfo weiboInfo, WeiboMultiMessage message) {
        ...
        LogUtil.m3307d(TAG, "WeiboMultiMessage WeiboInfo package : " + weiboInfo.getPackageName());
        LogUtil.m3307d(TAG, "WeiboMultiMessage WeiboInfo supportApi : " + weiboInfo.getSupportApi());
