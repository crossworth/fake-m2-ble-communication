...
public class WeiboDownloader {
    ...
    class C11102 implements OnClickListener {
        private final /* synthetic */ IWeiboDownloadListener val$listener;

        C11102(IWeiboDownloadListener iWeiboDownloadListener) {
    ...
    public static Dialog createDownloadConfirmDialog(Context context, IWeiboDownloadListener listener) {
        ...
        return new Builder(context).setMessage(prompt).setTitle(title).setPositiveButton(ok, new C11091(context)).setNegativeButton(cancel, new C11102(listener)).create();
    }
