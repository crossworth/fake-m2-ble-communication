...
*/
    ...
    L_0x006b:
        ...
        com.sina.weibo.sdk.utils.LogUtil.m3308e(r10, r11);	 Catch:{ WeiboException -> 0x0091, all -> 0x00a2 }
    ...
    public void stop() {
        if (this.thread == null || this.mHandler == null) {
            LogUtil.m3311w(TAG, "no thread running. please call start method first!");
            return;
        }
