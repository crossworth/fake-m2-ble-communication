...
public class WeiboSdkBrowser extends Activity implements BrowserRequestCallBack {
    ...
    class C11163 implements OnClickListener {
        C11163() {
        }
    ...
    private boolean initDataFromIntent(Intent data) {
        ...
        LogUtil.m3307d(TAG, "LOAD URL : " + this.mUrl);
        return true;
    }
    ...
    private void startShare() {
        LogUtil.m3307d(TAG, "Enter startShare()............");
        final ShareRequestParam req = this.mRequestParam;
        if (req.hasImage()) {
            LogUtil.m3307d(TAG, "loadUrl hasImage............");
            new AsyncWeiboRunner(this).requestAsync(ShareRequestParam.UPLOAD_PIC_URL, req.buildUploadPicParam(new WeiboParameters(req.getAppKey())), Constants.HTTP_POST, new RequestListener() {
                public void onWeiboException(WeiboException e) {
                    LogUtil.m3307d(WeiboSdkBrowser.TAG, "post onWeiboException " + e.getMessage());
                    req.sendSdkErrorResponse(WeiboSdkBrowser.this, e.getMessage());
                    WeiboSdkBrowser.this.finish();
                }

                public void onComplete(String response) {
                    LogUtil.m3307d(WeiboSdkBrowser.TAG, "post onComplete : " + response);
    ...
    private void setTopNavTitle() {
        ...
        this.mLeftBtn.setOnClickListener(new C11152());
    }
    ...
    private void setContentView() {
        ...
        this.mLoadErrorRetryBtn.setOnClickListener(new C11163());
    ...
    public void onPageStartedCallBack(WebView view, String url, Bitmap favicon) {
        LogUtil.m3307d(TAG, "onPageStarted URL: " + url);
        this.mUrl = url;
    ...
    public boolean shouldOverrideUrlLoadingCallBack(WebView view, String url) {
        LogUtil.m3309i(TAG, "shouldOverrideUrlLoading URL: " + url);
        return false;
    }

    public void onPageFinishedCallBack(WebView view, String url) {
        LogUtil.m3307d(TAG, "onPageFinished URL: " + url);
        if (this.isErrorPage) {
            promptError();
            return;
        }
    ...
    public void onReceivedErrorCallBack(WebView view, int errorCode, String description, String failingUrl) {
        LogUtil.m3307d(TAG, "onReceivedError: errorCode = " + errorCode + ", description = " + description + ", failingUrl = " + failingUrl);
    ...
    public void onReceivedSslErrorCallBack(WebView view, SslErrorHandler handler, SslError error) {
        LogUtil.m3307d(TAG, "onReceivedSslErrorCallBack.........");
    }
