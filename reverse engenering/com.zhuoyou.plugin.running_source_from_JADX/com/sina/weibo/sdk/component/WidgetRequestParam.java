...
public class WidgetRequestParam extends BrowserRequestParamBase {
    ...
    protected void onSetupRequestParam(Bundle data) {
        ...
        this.mCommentContent = data.getString("content");
        this.mCommentCategory = data.getString("category");
    ...
    public void onCreateRequestParamBundle(Bundle data) {
        ...
        data.putString("content", this.mCommentContent);
        data.putString("category", this.mCommentCategory);
