...
public class AttentionComponentView extends FrameLayout {
    ...
    class C11192 implements RequestListener {
        C11192() {
        }

        public void onWeiboException(WeiboException e) {
            LogUtil.m3307d(AttentionComponentView.TAG, "error : " + e.getMessage());
            AttentionComponentView.this.mIsLoadingState = false;
        }

        public void onComplete(String response) {
            LogUtil.m3307d(AttentionComponentView.TAG, "json : " + response);
            try {
                final JSONObject target = new JSONObject(response).optJSONObject("target");
    ...
    class C11203 implements WidgetRequestCallback {
        C11203() {
        }
    ...
    private void init(Context context) {
        ...
        this.flButton.setOnClickListener(new C11171());
    ...
    private void loadAttentionState(RequestParam req) {
        if (!this.mIsLoadingState) {
            ...
            NetUtils.internalHttpRequest(getContext(), FRIENDSHIPS_SHOW_URL, params, Constants.HTTP_GET, new C11192());
        }
    }
    ...
    private void execAttented() {
        ...
        req.setWidgetRequestCallback(new C11203());
