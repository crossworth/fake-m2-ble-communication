...
public class MobileRegisterActivity extends Activity implements OnFocusChangeListener, OnClickListener, SizeChangeListener {
    ...
    class C11282 implements ListenerOnTitleBtnClicked {
        C11282() {
        }
    ...
    class C11293 implements RequestListener {
        C11293() {
        }

        public void onWeiboException(WeiboException e) {
            LogUtil.m3307d(MobileRegisterActivity.TAG, "get onWeiboException " + e.getMessage());
            ...
            try {
                ...
                if (!TextUtils.isEmpty(res.optString(NativeProtocol.BRIDGE_ARG_ERROR_DESCRIPTION))) {
                    error_description = res.optString(NativeProtocol.BRIDGE_ARG_ERROR_DESCRIPTION);
                }
        ...
        public void onComplete(String response) {
            LogUtil.m3307d(MobileRegisterActivity.TAG, "get onComplete : " + response);
            if (response != null) {
                try {
    ...
    private void initView() {
        ...
        this.titleBar.setTitleBarClickListener(new C11282());
    ...
    public void getMsg(String phoneNum, String countryCode) {
        ...
        NetUtils.internalHttpRequest(this, SEND_MSG, params, Constants.HTTP_GET, new C11293());
    }
    ...
    public void submit(final String phoneNum, String checkCodeStr) {
        ...
        NetUtils.internalHttpRequest(this, SEND_SUBMIT, params, Constants.HTTP_GET, new RequestListener() {
            public void onWeiboException(WeiboException e) {
                LogUtil.m3307d(MobileRegisterActivity.TAG, "get onWeiboException " + e.getMessage());
