...
public class PinyinUtils {
    ...
    public MatchedResult getMatchedResult(String src, String input) {
        ...
        if (isLoad && !TextUtils.isEmpty(src) && !TextUtils.isEmpty(input)) {
            ...
            if (Math.min(src.length(), input.length()) > 10) {
