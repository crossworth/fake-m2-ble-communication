...
public class SelectCountryActivity extends Activity implements OnIndexChangeListener {
    ...
    class C11311 implements ListenerOnTitleBtnClicked {
        C11311() {
        }
    ...
    class C11322 implements OnItemClickListener {
        C11322() {
        }
    ...
    private void initView() {
        ...
        titleBar.setTitleBarClickListener(new C11311());
        ...
        this.mListView.setOnItemClickListener(new C11322());
