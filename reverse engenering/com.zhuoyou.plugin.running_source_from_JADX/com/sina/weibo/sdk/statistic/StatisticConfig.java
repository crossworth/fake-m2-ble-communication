...
class StatisticConfig {
    ...
    public static void setUploadInterval(long kUploadInterval) throws Exception {
        if (kUploadInterval < MIN_UPLOAD_INTERVAL || kUploadInterval > MAX_UPLOAD_INTERVAL) {
            throw new Exception("The interval must be between 30 seconds and 8 hours");
        }
        kUploadInterval = kUploadInterval;
    }
