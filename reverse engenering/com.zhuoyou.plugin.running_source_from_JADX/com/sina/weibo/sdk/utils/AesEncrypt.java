...
public class AesEncrypt {
    public static String Encrypt(String sSrc) {
        try {
            ...
            LogUtil.m3308e("Encrypt", e.getMessage());
            return null;
        }
    }
    ...
    public static String Decrypt(String strSrc) {
        try {
            ...
            try {
                ...
                LogUtil.m3308e("Decrypt", e.getMessage());
                return null;
            }
        } catch (Exception ex) {
            LogUtil.m3308e("Decrypt", ex.getMessage());
            return null;
        }
    }
    ...
    protected static Key generateKey(String strKey) {
        try {
            ...
            if (cKey == null) {
                LogUtil.m3310v("Decrypt", "Key为空null");
                return null;
            } else if (cKey.length() == 16) {
                return new SecretKeySpec(cKey.getBytes("utf-8"), "AES");
            } else {
                LogUtil.m3310v("Decrypt", "Key长度不是16位");
                return null;
            }
        } catch (Exception e) {
            LogUtil.m3308e("generateKey", e.getMessage());
            return null;
        }
    }
