...
public class SDKNotification {
    ...
    public static class SDKNotificationBuilder {
        ...
        public SDKNotification build(Context ctx) {
            ...
            return new SDKNotification(ctx, mNotificationBuilder.build());
        }
    ...
    public void show(int notificationId) {
        if (this.mNotification != null) {
            ((NotificationManager) this.mContext.getSystemService(MessageObj.CATEGORY_NOTI)).notify(notificationId, this.mNotification);
        }
    }
}
