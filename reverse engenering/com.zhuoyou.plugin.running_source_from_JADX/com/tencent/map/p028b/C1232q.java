...
public final class C1232q {
    private static int f3929a = 0;
    private static boolean f3930b;

    private static HttpURLConnection m3652a(String str, boolean z) {
        ...
        try {
            ...
            if (C1227l.m3646c()) {
                ...
                C1228m.m3649a();
                z2 = !C1198b.m3508a(Proxy.getDefaultHost());
            }
            if (z2) {
                String defaultHost;
                int defaultPort;
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                boolean a = C1232q.m3655a(httpURLConnection3);
    ...
    public static com.tencent.map.p028b.C1229n m3651a(boolean r6, java.lang.String r7, java.lang.String r8, java.lang.String r9, byte[] r10, boolean r11, boolean r12) throws java.lang.Exception {
        /*
        r2 = 1;
        r0 = 0;
        r1 = 0;
        r3 = com.tencent.map.p028b.C1227l.m3647d();
    ...
    L_0x0009:
        ...
        throw r0;
    L_0x000f:
        r3 = com.tencent.map.p028b.C1232q.m3652a(r7, r12);	 Catch:{ p -> 0x011b, Exception -> 0x0115, all -> 0x010f }
        r4 = 0;
        r4 = com.tencent.map.p028b.C1198b.m3508a(r4);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x002f:
        r4 = com.tencent.map.p028b.C1226k.m3634a();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r3.setConnectTimeout(r4);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r4 = com.tencent.map.p028b.C1226k.m3639b();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x0059:
        com.tencent.map.p028b.C1226k.m3637a(r3);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r3.connect();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        com.tencent.map.p028b.C1226k.m3642c();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x0087:
        com.tencent.map.p028b.C1226k.m3643d();	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r2 = com.tencent.map.p028b.C1232q.m3650a(r3, r6);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        if (r2 == 0) goto L_0x0097;
    L_0x0090:
        r4 = r2.f3927a;	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        if (r4 == 0) goto L_0x0097;
    L_0x0094:
        r0 = r2.f3927a;	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
        r0 = r0.length;	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    L_0x0097:
        com.tencent.map.p028b.C1226k.m3636a(r0);	 Catch:{ p -> 0x00a7, Exception -> 0x00c2 }
    ...
    L_0x00a9:
        r3 = 1;
        com.tencent.map.p028b.C1226k.m3638a(r3);	 Catch:{ all -> 0x00ae }
    ...
    L_0x00c3:
        r2 = 0;
        com.tencent.map.p028b.C1226k.m3638a(r2);	 Catch:{ all -> 0x00c8 }
    ...
    private static C1229n m3650a(HttpURLConnection httpURLConnection, boolean z) throws IOException {
        int i = 1;
        int i2 = 0;
            ...
            if (inputStream != null) {
                ...
                do {
                    ...
                    if (read > 0) {
                        ...
                        System.arraycopy(c1229n.f3927a, 0, obj2, 0, c1229n.f3927a.length);
                        System.arraycopy(obj, 0, obj2, c1229n.f3927a.length, read);
                        c1229n.f3927a = obj2;
                        continue;
                    }
                } while (read > 0);
    ...
    private static void m3654a(int i) {
        if (f3929a != i) {
            f3929a = i;
        }
    }

    private static boolean m3655a(HttpURLConnection httpURLConnection) throws IOException {
        InputStream inputStream = null;
        try {
            inputStream = httpURLConnection.getInputStream();
    ...
    private static HttpURLConnection m3653a(URL url, String str) throws IOException {
        String replaceFirst;
        int i = 80;
