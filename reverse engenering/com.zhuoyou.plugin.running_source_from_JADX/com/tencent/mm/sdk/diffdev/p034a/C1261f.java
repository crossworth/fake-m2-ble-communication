...
final class C1261f extends AsyncTask<Void, Void, C1260a> {
    ...
    static class C1260a {
        ...
        public static com.tencent.mm.sdk.diffdev.p034a.C1261f.C1260a m3694e(byte[] r9) {
            /*
            r8 = 1;
            r7 = 0;
    ...
    public C1261f(String str, OAuthListener oAuthListener) {
        this.aq = str;
    ...
    protected final /* synthetic */ Object doInBackground(Object[] objArr) {
        if (this.aq == null || this.aq.length() == 0) {
            ...
            c1260a.ap = OAuthErrCode.WechatAuth_Err_NormalErr;
            return c1260a;
        }
        while (!isCancelled()) {
            String str = this.url + (this.aw == 0 ? "" : "&last=" + this.aw);
            long currentTimeMillis = System.currentTimeMillis();
            byte[] b = C1259e.m3693b(str, 60000);
            long currentTimeMillis2 = System.currentTimeMillis();
            c1260a = C1260a.m3694e(b);
            Log.d("MicroMsg.SDK.NoopingTask", String.format("nooping, url = %s, errCode = %s, uuidStatusCode = %d, time consumed = %d(ms)", new Object[]{str, c1260a.ap.toString(), Integer.valueOf(c1260a.ay), Long.valueOf(currentTimeMillis2 - currentTimeMillis)}));
            if (c1260a.ap == OAuthErrCode.WechatAuth_Err_OK) {
                this.aw = c1260a.ay;
                if (c1260a.ay == C1262g.UUID_SCANED.getCode()) {
                    this.an.onQrcodeScanned();
                } else if (c1260a.ay != C1262g.UUID_KEEP_CONNECT.getCode() && c1260a.ay == C1262g.UUID_CONFIRM.getCode()) {
                    if (c1260a.ax != null && c1260a.ax.length() != 0) {
                        return c1260a;
                    }
            ...
            Log.e("MicroMsg.SDK.NoopingTask", String.format("nooping fail, errCode = %s, uuidStatusCode = %d", new Object[]{c1260a.ap.toString(), Integer.valueOf(c1260a.ay)}));
            return c1260a;
        }
        Log.i("MicroMsg.SDK.NoopingTask", "IDiffDevOAuth.stopAuth / detach invoked");
        c1260a = new C1260a();
        c1260a.ap = OAuthErrCode.WechatAuth_Err_Auth_Stopped;
        return c1260a;
    }

    protected final /* synthetic */ void onPostExecute(Object obj) {
        C1260a c1260a = (C1260a) obj;
        this.an.onAuthFinish(c1260a.ap, c1260a.ax);
    }
}
