    ...
    public static class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            if (this.toUserName == null || this.toUserName.length() == 0) {
                C1242b.m3667b(TAG, "checkArgs fail, toUserName is invalid");
                return false;
            } else if (this.extMsg != null && this.extMsg.length() > 1024) {
                C1242b.m3667b(TAG, "ext msg is not null, while the length exceed 1024 bytes");
                return false;
            } else if (this.profileType != 1 || (this.extMsg != null && this.extMsg.length() != 0)) {
                return true;
            } else {
                C1242b.m3667b(TAG, "scene is jump to hardware profile, while extmsg is null");
                return false;
            }
        }
