...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                e.printStackTrace();
                C1242b.m3667b(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            C1242b.m3667b(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }
        ...
        private static String pathOldToNew(String str) {
            ...
            C1242b.m3667b(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
            return str;
        }
    ...
    final boolean checkArgs() {
        if (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) {
            C1242b.m3667b(TAG, "checkArgs fail, thumbData should not be null when send emoji");
            return false;
        } else if (this.thumbData != null && this.thumbData.length > 32768) {
            C1242b.m3667b(TAG, "checkArgs fail, thumbData is invalid");
            return false;
        } else if (this.title != null && this.title.length() > 512) {
            C1242b.m3667b(TAG, "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() > 1024) {
            C1242b.m3667b(TAG, "checkArgs fail, description is invalid");
            return false;
        } else if (this.mediaObject == null) {
            C1242b.m3667b(TAG, "checkArgs fail, mediaObject is null");
            return false;
        } else if (this.mediaTagName != null && this.mediaTagName.length() > 64) {
            C1242b.m3667b(TAG, "checkArgs fail, mediaTagName is too long");
            return false;
        } else if (this.messageAction != null && this.messageAction.length() > 2048) {
            C1242b.m3667b(TAG, "checkArgs fail, messageAction is too long");
            return false;
        } else if (this.messageExt == null || this.messageExt.length() <= 2048) {
            return this.mediaObject.checkArgs();
        } else {
            C1242b.m3667b(TAG, "checkArgs fail, messageExt is too long");
            return false;
        }
    }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            e.printStackTrace();
            C1242b.m3667b(TAG, "put thumb failed");
        }
    }
}
