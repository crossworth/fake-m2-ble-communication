...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C1240a.m3661b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C1240a.m3660a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public boolean checkArgs() {
        if (this.appId == null || this.appId.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid appId");
            return false;
        } else if (this.partnerId == null || this.partnerId.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid partnerId");
            return false;
        } else if (this.prepayId == null || this.prepayId.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid prepayId");
            return false;
        } else if (this.nonceStr == null || this.nonceStr.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid nonceStr");
            return false;
        } else if (this.timeStamp == null || this.timeStamp.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid timeStamp");
            return false;
        } else if (this.packageValue == null || this.packageValue.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid packageValue");
            return false;
        } else if (this.sign == null || this.sign.length() == 0) {
            C1242b.m3667b(TAG, "checkArgs fail, invalid sign");
            return false;
        } else if (this.extData == null || this.extData.length() <= 1024) {
            return true;
        } else {
            C1242b.m3667b(TAG, "checkArgs fail, extData length too long");
            return false;
        }
    }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C1240a.m3661b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C1240a.m3661b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C1240a.m3661b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C1240a.m3661b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C1240a.m3661b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C1240a.m3661b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C1240a.m3661b(bundle, "_wxapi_payreq_sign");
        this.extData = C1240a.m3661b(bundle, "_wxapi_payreq_extdata");
        this.signType = C1240a.m3661b(bundle, "_wxapi_payreq_sign_type");
