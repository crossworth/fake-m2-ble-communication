...
import com.tencent.mm.sdk.p030a.C1239a;
import com.tencent.mm.sdk.p030a.C1239a.C1235a;
import com.tencent.mm.sdk.p030a.p031a.C1237a;
import com.tencent.mm.sdk.p030a.p031a.C1237a.C1236a;
...
final class WXApiImplV10 implements IWXAPI {
    ...
    private static final class ActivityLifecycleCb implements ActivityLifecycleCallbacks {
        ...
        private ActivityLifecycleCb(Context context) {
            ...
            this.onPausedRunnable = new C12641();
            this.onResumedRunnable = new C12652();
    ...
    WXApiImplV10(Context context, String str, boolean z) {
        C1242b.m3670e(TAG, "<init>, appId = " + str + ", checkSignature = " + z);
        this.context = context;
        this.appId = str;
    ...
    private boolean checkSumConsistent(byte[] bArr, byte[] bArr2) {
        if (bArr == null || bArr.length == 0 || bArr2 == null || bArr2.length == 0) {
            C1242b.m3667b(TAG, "checkSumConsistent fail, invalid arguments");
            return false;
        } else if (bArr.length != bArr2.length) {
            C1242b.m3667b(TAG, "checkSumConsistent fail, length is different");
            return false;
        } else {
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            C1242b.m3670e(TAG, "pay, set wxappPayEntryClassname = " + wxappPayEntryClassname);
            if (wxappPayEntryClassname == null) {
                C1242b.m3667b(TAG, "pay fail, wxappPayEntryClassname is null");
                return false;
            }
        }
        C1235a c1235a = new C1235a();
        c1235a.f3934Z = bundle;
        c1235a.f3931W = WXApp.WXAPP_PACKAGE_NAME;
        c1235a.f3932X = wxappPayEntryClassname;
        return C1239a.m3659a(context, c1235a);
    }

    public final void detach() {
        C1242b.m3670e(TAG, "detach");
        this.detached = true;
    ...
    public final int getWXAppSupportAPI() {
        if (this.detached) {
            ...
            C1242b.m3667b(TAG, "open wx app failed, not installed or signature check failed");
            return 0;
        }
    }
    ...
    public final boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            if (!WXApiImplComm.isIntentFromWx(intent, Token.WX_TOKEN_VALUE_MSG)) {
                C1242b.m3669d(TAG, "handleIntent fail, intent not from weixin msg");
                return false;
                ...
                if (stringExtra2 == null || stringExtra2.length() == 0) {
                    C1242b.m3667b(TAG, "invalid argument");
                    return false;
                } else if (checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), C1238b.m3658a(stringExtra, intExtra, stringExtra2))) {
                    ...
                    switch (intExtra2) {
                        ...
                        case 15:
                            ...
                            return true;
                        default:
                            C1242b.m3667b(TAG, "unknown cmd = " + intExtra2);
                            return false;
                    }
                } else {
                    C1242b.m3667b(TAG, "checksum fail");
                    return false;
                }
            }
        } catch (Exception e) {
            C1242b.m3666a(TAG, "handleIntent fail, ex = %s", e.getMessage());
            return false;
        }
    }
    ...
    public final boolean openWXApp() {
        if (this.detached) {
            ...
            try {
                ...
                C1242b.m3667b(TAG, "startActivity fail, exception = " + e.getMessage());
                return false;
            }
        } else {
            C1242b.m3667b(TAG, "open wx app failed, not installed or signature check failed");
        ...
        if (this.detached) {
            ...
            if (activityCb == null && VERSION.SDK_INT >= 14) {
                if (this.context instanceof Activity) {
                    ...
                    C1242b.m3668c(TAG, "context is not instanceof Activity or Service, disable WXStat");
                }
            }
            C1242b.m3670e(TAG, "registerApp, appId = " + str);
            if (str != null) {
                this.appId = str;
            }
            C1242b.m3670e(TAG, "register app " + this.context.getPackageName());
            C1236a c1236a = new C1236a();
            c1236a.aa = WXApp.WXAPP_PACKAGE_NAME;
            c1236a.ab = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
            c1236a.f3935Y = "weixin://registerapp?appid=" + this.appId;
            return C1237a.m3657a(this.context, c1236a);
        } else {
            C1242b.m3667b(TAG, "register app failed for wechat app signature check failed");
            return false;
        }
    }
    ...
    public final boolean sendReq(BaseReq baseReq) {
        if (this.detached) {
            ...
            C1242b.m3667b(TAG, "sendReq failed for wechat app signature check failed");
            return false;
        } else if (baseReq.checkArgs()) {
            C1242b.m3670e(TAG, "sendReq, req type = " + baseReq.getType());
            ...
            C1235a c1235a = new C1235a();
            c1235a.f3934Z = bundle;
            c1235a.f3933Y = "weixin://sendreq?appid=" + this.appId;
            c1235a.f3931W = WXApp.WXAPP_PACKAGE_NAME;
            c1235a.f3932X = WXApp.WXAPP_MSG_ENTRY_CLASSNAME;
            return C1239a.m3659a(this.context, c1235a);
        } else {
            C1242b.m3667b(TAG, "sendReq checkArgs fail");
            return false;
        }
    }
    ...
    public final boolean sendResp(BaseResp baseResp) {
        if (this.detached) {
            ...
            C1242b.m3667b(TAG, "sendResp failed for wechat app signature check failed");
            return false;
            ...
            C1235a c1235a = new C1235a();
            c1235a.f3934Z = bundle;
            c1235a.f3933Y = "weixin://sendresp?appid=" + this.appId;
            c1235a.f3931W = WXApp.WXAPP_PACKAGE_NAME;
            c1235a.f3932X = WXApp.WXAPP_MSG_ENTRY_CLASSNAME;
            return C1239a.m3659a(this.context, c1235a);
        } else {
            C1242b.m3667b(TAG, "sendResp checkArgs fail");
            return false;
        }
    }
    ...
    public final void unregisterApp() {
        if (this.detached) {
            ...
            C1242b.m3670e(TAG, "unregisterApp, appId = " + this.appId);
            if (this.appId == null || this.appId.length() == 0) {
                C1242b.m3667b(TAG, "unregisterApp fail, appId is empty");
                return;
            }
            C1242b.m3670e(TAG, "unregister app " + this.context.getPackageName());
            C1236a c1236a = new C1236a();
            c1236a.aa = WXApp.WXAPP_PACKAGE_NAME;
            c1236a.ab = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
            c1236a.f3935Y = "weixin://unregisterapp?appid=" + this.appId;
            C1237a.m3657a(this.context, c1236a);
        } else {
            C1242b.m3667b(TAG, "unregister app failed for wechat app signature check failed");
        }
    }
}
