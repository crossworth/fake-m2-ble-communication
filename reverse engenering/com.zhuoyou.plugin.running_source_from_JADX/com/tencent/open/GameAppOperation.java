...
import com.tencent.open.p037b.C1321c;
...
public class GameAppOperation extends BaseApi {
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "-->makeFriend()  -- start");
        if (bundle == null) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->makeFriend params is null");
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
            return;
        }
        String string = bundle.getString(GAME_FRIEND_OPENID);
        if (TextUtils.isEmpty(string)) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->make friend, fOpenid is empty.");
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
            return;
        }
        ...
        C1314f.m3864a("openSDK_LOG.GameAppOperation", "-->make friend, fOpenid: " + string + " | label: " + string2 + " | message: " + string3 + " | openid: " + openId + " | appid:" + appId);
        ...
        C1314f.m3864a("openSDK_LOG.GameAppOperation", "-->make friend, url: " + stringBuffer.toString());
        Intent intent = new Intent("android.intent.action.VIEW");
        intent.setData(Uri.parse(stringBuffer.toString()));
        if (!hasActivityForIntent(intent) || Util.isQQVersionBelow(activity, SystemUtils.QQ_VERSION_NAME_5_1_0)) {
            C1314f.m3871d("openSDK_LOG.GameAppOperation", "-->make friend, there is no activity.");
            m3697a(activity);
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
        } else {
            C1314f.m3870c("openSDK_LOG.GameAppOperation", "-->makeFriend target activity found, qqver greater than 5.1.0");
            try {
                activity.startActivity(intent);
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "0");
            } catch (Throwable e) {
                C1314f.m3868b("openSDK_LOG.GameAppOperation", "-->make friend, start activity exception.", e);
                m3697a(activity);
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
            }
        }
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "-->makeFriend()  -- end");
    }

    public void bindQQGroup(Activity activity, Bundle bundle) {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "-->bindQQGroup()  -- start");
        if (activity == null) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, activity is empty.");
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
        } else if (bundle == null) {
            Toast.makeText(activity, "Bundle参数为空", 0).show();
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, params is empty.");
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
        } else {
            Object applicationLable = Util.getApplicationLable(activity);
            ...
            if (TextUtils.isEmpty(applicationLable)) {
                ...
                C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, game union id is empty.");
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                return;
            }
            ...
            if (TextUtils.isEmpty(applicationLable)) {
                ...
                C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, game union name is empty.");
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                return;
            }
            ...
            if (TextUtils.isEmpty(applicationLable)) {
                ...
                C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, game zone id  is empty.");
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                return;
            }
            ...
            if (TextUtils.isEmpty(applicationLable)) {
                ...
                C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, game signature is empty.");
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                return;
            }
            ...
            if (TextUtils.isEmpty(applicationLable)) {
                ...
                C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->bindQQGroup, openid is empty.");
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                return;
            }
            ...
            C1314f.m3864a("openSDK_LOG.GameAppOperation", "-->bindQQGroup, url: " + stringBuffer.toString());
            Intent intent = new Intent("android.intent.action.VIEW");
            intent.setData(Uri.parse(stringBuffer.toString()));
            if (!hasActivityForIntent(intent) || Util.isQQVersionBelow(activity, SystemUtils.QQ_VERSION_NAME_5_1_0)) {
                C1314f.m3871d("openSDK_LOG.GameAppOperation", "-->bind group, there is no activity, show download page.");
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                m3697a(activity);
            } else {
                C1314f.m3870c("openSDK_LOG.GameAppOperation", "-->bingQQGroup target activity found, qqver > 5.1.0");
                try {
                    activity.startActivity(intent);
                    C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "0");
                } catch (Throwable e) {
                    C1314f.m3868b("openSDK_LOG.GameAppOperation", "-->bind group, start activity exception.", e);
                    C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_BIND_GROUP, "18", "18", "1");
                    m3697a(activity);
                }
            }
            C1314f.m3870c("openSDK_LOG.GameAppOperation", "-->bindQQGroup()  -- end");
        }
    }

    public void addToQQFavorites(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "addToQQFavorites() -- start");
        int i = bundle.getInt("req_type", 1);
        if (m3700a(activity, bundle, iUiListener)) {
            String string;
            ...
            Object appId = this.mToken.getAppId();
            Object openId = this.mToken.getOpenId();
            C1314f.m3864a("openSDK_LOG.GameAppOperation", "addToQQFavorites openId:" + openId);
            if (!TextUtils.isEmpty(string2)) {
            ...
            if (stringArrayList != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    try {
                        ...
                        e.printStackTrace();
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "UnsupportedEncodingException", e);
            ...
            if (!TextUtils.isEmpty(string)) {
                if (string.length() > 20) {
                    string = string.substring(0, 20) + com.droi.btlib.service.Util.TEXT_POSTFIX;
                }
            ...
            C1314f.m3864a("openSDK_LOG.GameAppOperation", "addToQQFavorites url: " + stringBuffer.toString());
            C1148a.m3344a(Global.getContext(), this.mToken, "requireApi", SystemUtils.QQFAVORITES_CALLBACK_ACTION);
            Intent intent = new Intent("android.intent.action.VIEW");
            intent.setData(Uri.parse(stringBuffer.toString()));
            ...
            if (hasActivityForIntent(intent)) {
                if (!Util.isQQVersionBelow(activity, SystemUtils.QQ_VERSION_NAME_5_2_0)) {
                    try {
                        activity.startActivity(intent);
                        m3699a(Constants.VIA_REPORT_TYPE_QQFAVORITES, i, "0");
                    } catch (Throwable e2) {
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "-->addToQQFavorites, start activity exception.", e2);
                        m3699a(Constants.VIA_REPORT_TYPE_QQFAVORITES, i, "1");
                        m3697a(activity);
                    }
                    C1314f.m3870c("openSDK_LOG.GameAppOperation", "addToQQFavorites() --end");
                    return;
                }
            }
            C1314f.m3871d("openSDK_LOG.GameAppOperation", "-->addToQQFavorites, there is no activity, show download page.");
            m3699a(Constants.VIA_REPORT_TYPE_QQFAVORITES, i, "1");
            m3697a(activity);
            C1314f.m3870c("openSDK_LOG.GameAppOperation", "addToQQFavorites() --end");
            return;
        }
        C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->addToQQFavorites check parames failed");
        m3699a(Constants.VIA_REPORT_TYPE_QQFAVORITES, i, "1");
    }

    public void sendToMyComputer(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "sendToMyComputer() --start");
        int i = bundle.getInt("req_type", 1);
        if (m3700a(activity, bundle, iUiListener)) {
            String string;
            ...
            Object appId = this.mToken.getAppId();
            Object openId = this.mToken.getOpenId();
            C1314f.m3864a("openSDK_LOG.GameAppOperation", "openId:" + openId);
            if (!TextUtils.isEmpty(string2)) {
                stringBuffer.append("&image_url=" + Base64.encodeToString(Util.getBytesUTF8(string2), 2));
            }
            if (stringArrayList != null) {
            ...
            stringBuffer.append("&req_type=" + Base64.encodeToString(Util.getBytesUTF8(String.valueOf(i)), 2));
            C1314f.m3864a("openSDK_LOG.GameAppOperation", "sendToMyComputer url: " + stringBuffer.toString());
            C1148a.m3344a(Global.getContext(), this.mToken, "requireApi", SystemUtils.QQDATALINE_CALLBACK_ACTION);
            Intent intent = new Intent("android.intent.action.VIEW");
            intent.setData(Uri.parse(stringBuffer.toString()));
            intent.putExtra("pkg_name", activity.getPackageName());
            ...
            if (hasActivityForIntent(intent)) {
                if (!Util.isQQVersionBelow(activity, SystemUtils.QQ_VERSION_NAME_5_2_0)) {
                    try {
                        ...
                        m3699a(Constants.VIA_REPORT_TYPE_DATALINE, i, "0");
                    } catch (Throwable e2) {
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "-->sendToMyComputer, start activity exception.", e2);
                        m3699a(Constants.VIA_REPORT_TYPE_DATALINE, i, "1");
                        m3697a(activity);
                    }
                    C1314f.m3870c("openSDK_LOG.GameAppOperation", "sendToMyComputer() --end");
                    return;
                }
            }
            C1314f.m3871d("openSDK_LOG.GameAppOperation", "-->sendToMyComputer, there is no activity, show download page.");
            m3699a(Constants.VIA_REPORT_TYPE_DATALINE, i, "1");
            m3697a(activity);
            C1314f.m3870c("openSDK_LOG.GameAppOperation", "sendToMyComputer() --end");
            return;
        }
        C1314f.m3872e("openSDK_LOG.GameAppOperation", "-->sendToMyComputer check parames failed");
        m3699a(Constants.VIA_REPORT_TYPE_DATALINE, i, "1");
    }

    public void shareToTroopBar(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "shareToTroopBar() -- start");
        String str = Constants.MSG_PARAM_ERROR;
        if (iUiListener == null) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "listener is null!");
        } else if (activity == null || bundle == null) {
            String str2 = "activity or params is null!";
            C1314f.m3872e("openSDK_LOG.GameAppOperation", str2);
                ...
                if (TextUtils.isEmpty(string2)) {
                    ...
                    if (stringArrayList != null && stringArrayList.size() > 0) {
                        ...
                        if (size > 9) {
                            ...
                            C1314f.m3872e("openSDK_LOG.GameAppOperation", "shareToTroopBar() -- file_data size: 1 ~ 9");
                            return;
                        }
                        int i = 0;
                        while (i < size) {
                            ...
                            if (!str3.startsWith("/")) {
                                ...
                                C1314f.m3872e("openSDK_LOG.GameAppOperation", "shareToTroopBar(): file_data应该为本地图片");
                                return;
                            } else if (!str3.startsWith("/") || new File(str3).exists()) {
                                i++;
                            } else {
                                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_ERROR, "图片文件不存在"));
                                C1314f.m3872e("openSDK_LOG.GameAppOperation", "shareToTroopBar(): 图片文件不存在");
                                return;
                            }
                        }
                        for (i = 0; i < size; i++) {
                    ...
                    if (TextUtils.isEmpty(string3) || Util.isNumeric(string3)) {
                        ...
                        Object appId = this.mToken.getAppId();
                        Object openId = this.mToken.getOpenId();
                        C1314f.m3864a("openSDK_LOG.GameAppOperation", "shareToTroopBar() -- openId: " + openId);
                        ...
                        if (!TextUtils.isEmpty(str3)) {
                            if (str3.length() > 20) {
                                str3 = str3.substring(0, 20) + com.droi.btlib.service.Util.TEXT_POSTFIX;
                            }
                        ...
                        C1314f.m3864a("openSDK_LOG.GameAppOperation", "shareToTroopBar, url: " + stringBuffer2.toString());
                        C1148a.m3344a(Global.getContext(), this.mToken, "requireApi", SystemUtils.TROOPBAR_CALLBACK_ACTION);
                        Intent intent = new Intent("android.intent.action.VIEW");
                        ...
                        if (!hasActivityForIntent(intent) || Util.isQQVersionBelow(activity, SystemUtils.QQ_VERSION_NAME_5_3_0)) {
                            C1314f.m3871d("openSDK_LOG.GameAppOperation", "-->shareToTroopBar, there is no activity, show download page.");
                            m3698a(activity, SystemUtils.QQ_VERSION_NAME_5_3_0);
                            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_TROOPBAR, Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR, "18", "1");
                        } else {
                            try {
                                startAssistActivity(activity, (int) Constants.REQUEST_SHARE_TO_TROOP_BAR, intent, false);
                                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_TROOPBAR, Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR, "18", "0");
                            } catch (Throwable e2) {
                                C1314f.m3868b("openSDK_LOG.GameAppOperation", "-->shareToTroopBar, start activity exception.", e2);
                                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_TROOPBAR, Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR, "18", "1");
                                m3698a(activity, SystemUtils.QQ_VERSION_NAME_5_3_0);
                            }
                        }
                        C1314f.m3870c("openSDK_LOG.GameAppOperation", "shareToTroopBar() -- end");
                        return;
                    }
                    iUiListener.onError(new UiError(-6, "传入参数有误! troopbar_id 必须为数字", null));
                    C1314f.m3872e("openSDK_LOG.GameAppOperation", "shareToTroopBar(): troopbar_id 必须为数字");
                }
            }
        }
    }
    ...
    public void sharePrizeToQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "sharePrizeToQQ() -- start");
        String str = Constants.MSG_PARAM_ERROR;
        if (iUiListener == null) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "listener is null!");
        } else if (activity == null || bundle == null) {
            r2 = "activity or params is null!";
            C1314f.m3872e("openSDK_LOG.GameAppOperation", r2);
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                final /* synthetic */ GameAppOperation f3941e;

                public void run() {
                    Bundle a = this.f3941e.m3695a();
                    if (a == null) {
                        String str = "accesstoken or openid or appid is null, please login first!";
                        C1314f.m3872e("openSDK_LOG.GameAppOperation", str);
                    ...
                    try {
                        JSONObject request = HttpUtils.request(this.f3941e.mToken, activity2.getApplicationContext(), ServerSetting.URL_PRIZE_MAKE_SHARE_URL, a, Constants.HTTP_GET);
                        try {
                            int i = request.getInt("ret");
                            int i2 = request.getInt("subCode");
                            if (i == 0 && i2 == 0) {
                                bundle2.putString("targetUrl", request.getString("share_url"));
                                new QQShare(activity2.getApplicationContext(), this.f3941e.mToken).shareToQQ(activity2, bundle2, iUiListener2);
                                return;
                            }
                            str = request.getString("msg");
                            iUiListener2.onError(new UiError(i, "make_share_url error.", str));
                            C1314f.m3870c("openSDK_LOG.GameAppOperation", "code = " + i + ", subcode = " + "errormsg = " + str);
                        } catch (JSONException e) {
                            C1314f.m3872e("openSDK_LOG.GameAppOperation", "JSONException occur in make_share_url, errorMsg: " + e.getMessage());
                            iUiListener2.onError(new UiError(-4, Constants.MSG_JSON_ERROR, ""));
                        }
                    } catch (Throwable e2) {
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "Exception occur in make_share_url", e2);
                        iUiListener2.onError(new UiError(-2, Constants.MSG_IO_ERROR, e2.getMessage()));
                    }
                }
            });
            C1314f.m3870c("openSDK_LOG.GameAppOperation", "sharePrizeToQQ() -- end");
        }
    }
    ...
    public void queryUnexchangePrize(Context context, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (iUiListener == null) {
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                final /* synthetic */ GameAppOperation f3945d;

                public void run() {
                    Bundle a = this.f3945d.m3695a();
                    if (a == null) {
                        String str = "accesstoken or openid or appid is null, please login first!";
                        C1314f.m3872e("openSDK_LOG.GameAppOperation", str);
                    ...
                    a.putAll(bundle);
                    try {
                        iUiListener.onComplete(HttpUtils.request(this.f3945d.mToken, context, ServerSetting.URL_PRIZE_QUERY_UNEXCHANGE, a, Constants.HTTP_GET));
                    } catch (Throwable e) {
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "Exception occur in queryUnexchangePrize", e);
    ...
    public void exchangePrize(Context context, Bundle bundle, final IUiListener iUiListener) {
        String str = Constants.MSG_PARAM_ERROR;
        if (iUiListener == null) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "exchangePrize listener is null!");
        } else if (bundle == null) {
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                final /* synthetic */ GameAppOperation f3949d;

                public void run() {
                    Bundle a = this.f3949d.m3695a();
                    if (a == null) {
                        String str = "accesstoken or openid or appid is null, please login first!";
                        C1314f.m3872e("openSDK_LOG.GameAppOperation", str);
                        iUiListener.onError(new UiError(-5, Constants.MSG_PARAM_ERROR, str));
                    ...
                    a.putString(SocializeProtocolConstants.PROTOCOL_KEY_IMEI, C1321c.m3892b(Global.getContext()));
                    try {
                        iUiListener.onComplete(HttpUtils.request(this.f3949d.mToken, context, ServerSetting.URL_PRIZE_EXCHANGE, a, Constants.HTTP_GET));
                    } catch (Throwable e) {
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "Exception occur in exchangePrize", e);
                        iUiListener.onError(new UiError(-2, Constants.MSG_IO_ERROR, e.getMessage()));
                    }
                }
            });
    ...
    private Bundle m3695a() {
        ...
        if (TextUtils.isEmpty(appId) || TextUtils.isEmpty(openId) || TextUtils.isEmpty(accessToken)) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "composeLoginStateParams fail, accesstoken or openid or appid is null");
            return null;
        }
    ...
    public void isActivityAvailable(final Activity activity, final String str, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            C1314f.m3872e("openSDK_LOG.GameAppOperation", str3);
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                final /* synthetic */ GameAppOperation f3953d;

                public void run() {
                    Bundle a = this.f3953d.m3695a();
                    if (a == null) {
                        String str = "accesstoken or openid or appid is null, please login first!";
                        C1314f.m3872e("openSDK_LOG.GameAppOperation", str);
                        iUiListener.onError(new UiError(-5, Constants.MSG_PARAM_ERROR, str));
                    ...
                    try {
                        iUiListener.onComplete(HttpUtils.request(this.f3953d.mToken, activity.getApplicationContext(), ServerSetting.URL_PRIZE_GET_ACTIVITY_STATE, a, Constants.HTTP_GET));
                    } catch (Throwable e) {
                        C1314f.m3868b("openSDK_LOG.GameAppOperation", "Exception occur in make_share_url", e);
    ...
    private boolean m3700a(Activity activity, Bundle bundle, IUiListener iUiListener) {
        if (activity == null || bundle == null || iUiListener == null) {
            C1314f.m3872e("openSDK_LOG.GameAppOperation", "activity or params or listener is null!");
            return false;
        }
        int i = bundle.getInt("req_type", 1);
    ...
    public void releaseResource() {
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "releaseResource() -- start");
        C1314f.m3870c("openSDK_LOG.GameAppOperation", "releaseResource() -- end");
    }

    private void m3697a(Activity activity) {
        m3698a(activity, "");
    }

    private void m3698a(Activity activity, String str) {
        new TDialog(activity, "", getCommonDownloadQQUrl(str), null, this.mToken).show();
    }

    private void m3699a(String str, int i, String str2) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            C1314f.m3864a("openSDK_LOG.GameAppOperation", "reportForVia() error: reportType or result is null");
            return;
        }
        String str3;
        String str4 = "";
        switch (i) {
            ...
            case 6:
                ...
                break;
            default:
                C1314f.m3872e("openSDK_LOG.GameAppOperation", "GameAppOperation -- reportForVia() error: unknow type " + String.valueOf(i));
                return;
        }
        C1322d.m3896a().m3900a(this.mToken.getOpenId(), this.mToken.getAppId(), "2", str, Constants.VIA_ACT_TYPE_TWENTY_EIGHT, str2, str3, "0", "", "");
    }
}
