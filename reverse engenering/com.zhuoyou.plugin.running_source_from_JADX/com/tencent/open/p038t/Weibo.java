package com.tencent.open.p038t;
...
public class Weibo extends BaseApi {
    ...
    public void sendPicText(String str, String str2, IUiListener iUiListener) {
        ...
        try {
            ...
            try {
                ...
                composeCGIParams.putByteArray(SocializeConstants.KEY_PIC, bArr);
    ...
    public void deleteText(String str, IUiListener iUiListener) {
        Bundle composeCGIParams = composeCGIParams();
        composeCGIParams.putString(ShareConstants.WEB_DIALOG_PARAM_ID, str);
