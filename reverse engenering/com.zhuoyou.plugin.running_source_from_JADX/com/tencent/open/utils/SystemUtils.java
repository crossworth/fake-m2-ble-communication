...
public class SystemUtils {
    ...
    public static boolean isAppSignatureValid(Context context, String str, String str2) {
        C1314f.m3864a("openSDK_LOG.SystemUtils", "OpenUi, validateAppSignatureForPackage");
        try {
    ...
    public static String getAppSignatureMD5(Context context, String str) {
        String packageName;
        Throwable e;
        C1314f.m3864a("openSDK_LOG.SystemUtils", "OpenUi, getSignValidString");
        String str2 = "";
        try {
            ...
            instance.reset();
            C1314f.m3864a("openSDK_LOG.SystemUtils", "-->sign: " + toHexString);
            instance.update(Util.getBytesUTF8(packageName + "_" + toHexString + "_" + str + ""));
            packageName = Util.toHexString(instance.digest());
            try {
                instance.reset();
                C1314f.m3864a("openSDK_LOG.SystemUtils", "-->signEncryped: " + packageName);
            } catch (Exception e2) {
                e = e2;
                e.printStackTrace();
                C1314f.m3868b("openSDK_LOG.SystemUtils", "OpenUi, getSignValidString error", e);
                return packageName;
            }
        } catch (Throwable e3) {
            Throwable th = e3;
    ...
    public static boolean checkMobileQQ(Context context) {
        ...
        try {
            ...
            C1314f.m3868b("openSDK_LOG.SystemUtils", "checkMobileQQ NameNotFoundException", e);
            e.printStackTrace();
            packageInfo = null;
        }
        if (packageInfo == null) {
        ...
        try {
            C1314f.m3867b("MobileQQ verson", str);
            String[] split = str.split("\\.");
            ...
            C1314f.m3868b("openSDK_LOG.SystemUtils", "checkMobileQQ Exception", e2);
            e2.printStackTrace();
            return false;
        }
    }
    ...
    public static boolean extractSecureLib(String str, String str2, int i) {
        ...
        C1314f.m3870c("openSDK_LOG.SystemUtils", "-->extractSecureLib, libName: " + str);
        Context context = Global.getContext();
        if (context == null) {
            C1314f.m3870c("openSDK_LOG.SystemUtils", "-->extractSecureLib, global context is null. ");
            return false;
        }
        ...
        if (file.exists()) {
            ...
            C1314f.m3870c("openSDK_LOG.SystemUtils", "-->extractSecureLib, libVersion: " + i + " | oldVersion: " + i2);
            if (i == i2) {
                return true;
            }
        }
        ...
        try {
            ...
            try {
                ...
                e = e5;
                try {
                    C1314f.m3868b("openSDK_LOG.SystemUtils", "-->extractSecureLib, when copy lib execption.", e);
                    if (open != null) {
                        try {
                            open.close();
    ...
    public static boolean isLibExtracted(String str, int i) {
        Context context = Global.getContext();
        if (context == null) {
            C1314f.m3870c("openSDK_LOG.SystemUtils", "-->isSecureLibExtracted, global context is null. ");
            return false;
        }
    ...
    private static long m3957a(InputStream inputStream, OutputStream outputStream) throws IOException {
        long j = 0;
        ...
        while (true) {
            ...
            if (read != -1) {
                ...
                C1314f.m3870c("openSDK_LOG.SystemUtils", "-->copy, copyed size is: " + j);
                return j;
            }
        }
    }
