...
public class WPA extends BaseApi {
    ...
    public void getWPAUserOnlineState(String str, IUiListener iUiListener) {
        if (str == null) {
            try {
                C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_WAP_STATE, Constants.VIA_REPORT_TYPE_WPA_STATE, "18", "1");
            ...
            Bundle bundle = null;
            HttpUtils.requestAsync(this.mToken, Global.getContext(), "http://webpresence.qq.com/getonline?Type=1&" + str + ":", bundle, Constants.HTTP_GET, new TempRequestListener(iUiListener));
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_WAP_STATE, Constants.VIA_REPORT_TYPE_WPA_STATE, "18", "0");
        }
    }
    ...
    public int startWPAConversation(Activity activity, String str, String str2, String str3) {
        ...
        if (TextUtils.isEmpty(str2)) {
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, str4, "18", "1");
            return -1;
            ...
            C1322d.m3896a().m3898a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, str4, "18", "0");
            return i;
        }
    }
}
