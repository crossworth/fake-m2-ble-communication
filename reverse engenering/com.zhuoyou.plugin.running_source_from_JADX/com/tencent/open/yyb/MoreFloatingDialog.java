...
public class MoreFloatingDialog extends Dialog {
    ...
    public MoreFloatingDialog(Context context) {
        ...
        C1314f.m3867b(TAG, "-->(MoreFloatingDialog) : density = " + this.density);
        LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        this.mContentView = new RelativeLayout(context);
        this.mContentView.setLayoutParams(layoutParams);
        this.mContentView.setBackgroundDrawable(C1362a.m3987a(SOURCE_FLOATING_BG, context, this.ninePatchRect));
        this.mRootView = new LinearLayout(context);
        layoutParams = new LinearLayout.LayoutParams(-1, -2);
        this.mRootView.setLayoutParams(layoutParams);
        this.mShareItems.put(SOURCE_QQ_BG, addShareItemText(C1362a.m3987a(SOURCE_QQ_BG, getContext(), this.ninePatchRect), "QQ分享"));
        this.mShareItems.put(SOURCE_QZONE_BG, addShareItemText(C1362a.m3987a(SOURCE_QZONE_BG, getContext(), this.ninePatchRect), "空间分享"));
