...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context) {
        ...
        setBackgroundDrawable(C1362a.m3986a(SOURCE_TITLEBAR, context));
        initBackLayout();
        initShareBtn();
    }
    ...
    private void initBackBtn() {
        ...
        this.backBtn.setBackgroundDrawable(C1362a.m3986a(SOURCE_BACK_BTN, getContext()));
    ...
    private void initShareBtn() {
        ...
        this.shareBtn.setBackgroundDrawable(C1362a.m3986a(SOURCE_MORE_BTN, getContext()));
