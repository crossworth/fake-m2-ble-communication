...
public final class AccessToken implements Parcelable {
    ...
    public static final Creator<AccessToken> CREATOR = new C14752();
    ...
    static class C14752 implements Creator {
        C14752() {
        }
        ...
        if (userId == null || userId.isEmpty()) {
            Utility.getGraphMeRequestWithCacheAsync(accessToken, new GraphMeRequestWithCacheCallback() {
                public void onSuccess(JSONObject userInfo) {
                    try {
                        extras.putString("user_id", userInfo.getString(ShareConstants.WEB_DIALOG_PARAM_ID));
    ...
    L_0x0004:
        return r1;
    L_0x0005:
        r3 = r6 instanceof com.umeng.facebook.AccessToken;
    ...
    L_0x000b:
        r0 = r6;
        r0 = (com.umeng.facebook.AccessToken) r0;
        r3 = r5.expires;
        r4 = r0.expires;
        r3 = r3.equals(r4);
    ...
    L_0x0064:
        goto L_0x004e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.facebook.AccessToken.equals(java.lang.Object):boolean");
    }
    ...
    private static AccessToken createFromBundle(List<String> requestedPermissions, Bundle bundle, AccessTokenSource source, Date expirationBase, String applicationId) {
        ...
        Date expires = Utility.getBundleLongAsDate(bundle, "expires_in", expirationBase);
