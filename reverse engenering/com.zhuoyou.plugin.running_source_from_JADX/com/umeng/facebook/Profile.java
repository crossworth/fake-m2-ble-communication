...
import com.umeng.facebook.internal.ImageRequest;
...
public final class Profile implements Parcelable {
    public static final Creator<Profile> CREATOR = new C14922();
    ...
    static class C14911 implements GraphMeRequestWithCacheCallback {
        C14911() {
        }
    ...
    static class C14922 implements Creator {
        C14922() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (accessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(), new C14911());
        }
    }
