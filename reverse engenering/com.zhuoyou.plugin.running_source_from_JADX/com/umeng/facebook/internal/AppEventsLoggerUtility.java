...
public class AppEventsLoggerUtility {
    private static final Map<GraphAPIActivityType, String> API_ACTIVITY_TYPE_TO_STRING = new C14951();

    static class C14951 extends HashMap<GraphAPIActivityType, String> {
        C14951() {
