...
public final class NativeProtocol {
    ...
    static class C15161 implements Runnable {
        C15161() {
        }
    ...
    private static abstract class NativeAppInfo {
        ...
        L_0x0007:
            r0 = com.umeng.facebook.internal.NativeProtocol.fetchAllAvailableProtocolVersionsForAppInfo(r1);	 Catch:{ all -> 0x000f }
        ...
        L_0x000f:
            ...
            throw r0;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.umeng.facebook.internal.NativeProtocol.NativeAppInfo.fetchAvailableVersions(boolean):void");
        }
    }
    ...
    public static Intent createProxyAuthIntent(Context context, String applicationId, Collection<String> permissions, String e2e, boolean isRerequest, boolean isForPublish, DefaultAudience defaultAudience) {
        for (NativeAppInfo appInfo : facebookAppInfoList) {
            ...
            intent.putExtra("response_type", ServerProtocol.DIALOG_RESPONSE_TYPE_TOKEN_AND_SIGNED_REQUEST);
    ...
    public static void updateAllAvailableProtocolVersionsAsync() {
        if (protocolVersionsAsyncUpdating.compareAndSet(false, true)) {
            FacebookSdk.getExecutor().execute(new C15161());
        }
    }
