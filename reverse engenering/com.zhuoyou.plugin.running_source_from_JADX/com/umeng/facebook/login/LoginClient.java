...
class LoginClient implements Parcelable {
    public static final Creator<LoginClient> CREATOR = new C15291();
    ...
    static class C15291 implements Creator {
        C15291() {
        }
    ...
    public static class Request implements Parcelable {
        public static final Creator<Request> CREATOR = new C15301();
        ...
        static class C15301 implements Creator {
            C15301() {
            }
    ...
    public static class Result implements Parcelable {
        public static final Creator<Result> CREATOR = new C15311();
        final Code code;
        ...
        static class C15311 implements Creator {
            C15311() {
            }
