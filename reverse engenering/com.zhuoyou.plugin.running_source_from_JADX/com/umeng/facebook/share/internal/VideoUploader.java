...
import com.umeng.facebook.internal.WorkQueue;
import com.umeng.facebook.internal.WorkQueue.WorkItem;
...
public class VideoUploader {
    ...
    static class C15471 extends AccessTokenTracker {
        C15471() {
        }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new C15511(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * 5000));
            return true;
        }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C15481();

        static class C15481 extends HashSet<Integer> {
            C15481() {
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C15491();

        static class C15491 extends HashSet<Integer> {
            C15491() {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C15501();
        private String chunkEnd;
        private String chunkStart;

        static class C15501 extends HashSet<Integer> {
            C15501() {
    ...
    public static synchronized void uploadAsync(ShareVideoContent videoContent, String targetId, FacebookCallback<Result> callback) throws FileNotFoundException {
        synchronized (VideoUploader.class) {
            ...
            Uri videoUri = videoContent.getVideo().getLocalUrl();
