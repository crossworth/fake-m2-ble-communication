...
public final class ShareLinkContent extends ShareContent<ShareLinkContent, Builder> {
    public static final Creator<ShareLinkContent> CREATOR = new C15561();
    private final String contentDescription;
    private final String contentTitle;
    private final Uri imageUrl;

    static class C15561 implements Creator<ShareLinkContent> {
        C15561() {
        }
    ...
    public static final class Builder extends com.umeng.facebook.share.model.ShareContent.Builder<ShareLinkContent, Builder> {
