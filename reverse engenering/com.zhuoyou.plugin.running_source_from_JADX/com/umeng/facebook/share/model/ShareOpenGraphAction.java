...
public final class ShareOpenGraphAction extends ShareOpenGraphValueContainer<ShareOpenGraphAction, Builder> {
    public static final Creator<ShareOpenGraphAction> CREATOR = new C15571();

    static class C15571 implements Creator<ShareOpenGraphAction> {
        C15571() {
        }
    ...
    public static final class Builder extends com.umeng.facebook.share.model.ShareOpenGraphValueContainer.Builder<ShareOpenGraphAction, Builder> {
