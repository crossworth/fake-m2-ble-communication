...
public final class ShareOpenGraphContent extends ShareContent<ShareOpenGraphContent, Builder> {
    public static final Creator<ShareOpenGraphContent> CREATOR = new C15581();
    private final ShareOpenGraphAction action;
    private final String previewPropertyName;

    static class C15581 implements Creator<ShareOpenGraphContent> {
        C15581() {
        }
    ...
    public static final class Builder extends com.umeng.facebook.share.model.ShareContent.Builder<ShareOpenGraphContent, Builder> {
        ...
        public Builder setAction(@Nullable ShareOpenGraphAction action) {
            ...
            if (action == null) {
                ...
                shareOpenGraphAction = new com.umeng.facebook.share.model.ShareOpenGraphAction.Builder().readFrom(action).build();
            }
    ...
    ShareOpenGraphContent(Parcel in) {
        super(in);
        this.action = new com.umeng.facebook.share.model.ShareOpenGraphAction.Builder().readFrom(in).build();
