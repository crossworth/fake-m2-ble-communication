...
public final class SharePhotoContent extends ShareContent<SharePhotoContent, Builder> {
    public static final Creator<SharePhotoContent> CREATOR = new C15611();
    private final List<SharePhoto> photos;

    static class C15611 implements Creator<SharePhotoContent> {
        C15611() {
        }
    ...
    public static class Builder extends com.umeng.facebook.share.model.ShareContent.Builder<SharePhotoContent, Builder> {
        private final List<SharePhoto> photos = new ArrayList();

        public Builder addPhoto(@Nullable SharePhoto photo) {
            if (photo != null) {
                this.photos.add(new com.umeng.facebook.share.model.SharePhoto.Builder().readFrom(photo).build());
            }
            return this;
        }
    ...
    SharePhotoContent(Parcel in) {
        super(in);
        this.photos = Collections.unmodifiableList(com.umeng.facebook.share.model.SharePhoto.Builder.readListFrom(in));
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        com.umeng.facebook.share.model.SharePhoto.Builder.writeListTo(out, this.photos);
    }
}
