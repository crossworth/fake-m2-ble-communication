...
public final class ShareVideoContent extends ShareContent<ShareVideoContent, Builder> implements ShareModel {
    public static final Creator<ShareVideoContent> CREATOR = new C15631();
    private final String contentDescription;
    private final String contentTitle;
    private final SharePhoto previewPhoto;
    private final ShareVideo video;

    static class C15631 implements Creator<ShareVideoContent> {
        C15631() {
        }
    ...
    public static final class Builder extends com.umeng.facebook.share.model.ShareContent.Builder<ShareVideoContent, Builder> {
        ...
        public Builder setPreviewPhoto(@Nullable SharePhoto previewPhoto) {
            ...
            if (previewPhoto == null) {
                ...
                sharePhoto = new com.umeng.facebook.share.model.SharePhoto.Builder().readFrom(previewPhoto).build();
            }
        ...
        public Builder setVideo(@Nullable ShareVideo video) {
            if (video != null) {
                this.video = new com.umeng.facebook.share.model.ShareVideo.Builder().readFrom(video).build();
            }
            return this;
        }
    ...
    private ShareVideoContent(Builder builder) {
        super((com.umeng.facebook.share.model.ShareContent.Builder) builder);
    ...
    ShareVideoContent(Parcel in) {
        ...
        com.umeng.facebook.share.model.SharePhoto.Builder previewPhotoBuilder = new com.umeng.facebook.share.model.SharePhoto.Builder().readFrom(in);
        ...
        this.video = new com.umeng.facebook.share.model.ShareVideo.Builder().readFrom(in).build();
    }
