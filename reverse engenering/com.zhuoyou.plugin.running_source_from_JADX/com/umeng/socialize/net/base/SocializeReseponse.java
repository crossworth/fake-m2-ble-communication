...
public class SocializeReseponse extends UResponse {
    ...
    public boolean isOk() {
        ...
        Log.m4546d(str, append.append(z).toString());
    ...
    private JSONObject parseStatus(JSONObject jSONObject) {
        if (jSONObject == null) {
            Log.m4549e(TAG, "failed requesting");
            return null;
        }
        try {
            ...
            if (this.mStCode == 0) {
                Log.m4549e(TAG, "no status code in response.");
                return null;
            }
            ...
            e.printStackTrace();
            Log.m4549e(TAG, "Data body can`t convert to json ");
            return null;
        }
    }
    ...
    private void printLog(String str, String str2) {
        Log.m4549e(TAG, "error message -> " + str + " : " + str2);
    }
}
