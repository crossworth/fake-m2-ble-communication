...
public class URLBuilder {
    ...
    public URLBuilder(Context context) {
        ...
        this.sdkversion = SocializeConstants.SDK_VERSION;
        this.os = SocializeConstants.OS;
    ...
    public String toEncript() {
        ...
        Log.m4551i("base url: " + stringBuilder.toString());
        Log.m4551i("params: " + buildParams);
        ...
        try {
            ...
            Log.m4557w("fail to encrypt query string");
            stringBuilder.append(buildParams);
        }
        return stringBuilder.toString();
    }
