...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, C1680R.styleable.CircleImageView));
    }
    ...
    private void parseAttributes(TypedArray a) {
        this.mBorderWidth = a.getDimension(0, 0.0f);
    ...
    public void setBorderWidth(int borderWidth) {
        if (((float) borderWidth) != this.mBorderWidth) {
            this.mBorderWidth = (float) borderWidth;
            setup();
        }
    }
