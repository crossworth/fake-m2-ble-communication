...
public class ProgressWheel extends View {
    ...
    static class WheelSavedState extends BaseSavedState {
        public static final Creator<WheelSavedState> CREATOR = new C19501();
        int barColor;
        int barWidth;
        int circleRadius;
        boolean fillRadius;
        ...
        static class C19501 implements Creator<WheelSavedState> {
            C19501() {
            }
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs, C1680R.styleable.ProgressWheel));
        setAnimationEnabled();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == DataConstants.BYTES_PER_GIGABYTE || widthMode == DataConstants.BYTES_PER_GIGABYTE) {
            height = heightSize;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.shouldAnimate) {
            if (this.isSpinning) {
                ...
                if (!this.linearProgress) {
                    offset = ((float) (WeightedLatLng.DEFAULT_INTENSITY - Math.pow((double) (1.0f - (this.mProgress / 360.0f)), (double) (2.0f * 2.0f)))) * 360.0f;
                    progress = ((float) (WeightedLatLng.DEFAULT_INTENSITY - Math.pow((double) (1.0f - (this.mProgress / 360.0f)), (double) 1073741824))) * 360.0f;
                }
                if (isInEditMode()) {
                    progress = 360.0f;
                }
    ...
    private void updateBarLength(long deltaTimeInMilliSeconds) {
        if (this.pausedTimeWithoutGrowing >= 200) {
            ...
            float distance = (((float) Math.cos(((this.timeStartGrowing / this.barSpinCycleTime) + WeightedLatLng.DEFAULT_INTENSITY) * 3.141592653589793d)) / 2.0f) + 0.5f;
