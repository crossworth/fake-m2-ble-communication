...
public class PieChartTouchHandler extends ChartTouchHandler {
    ...
    private class ChartGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            PieChartTouchHandler.this.scroller.abortAnimation();
            PieChartTouchHandler.this.scroller.fling(0, PieChartTouchHandler.this.pieChart.getChartRotation(), 0, ((int) scrollTheta) / 4, 0, 0, Integer.MIN_VALUE, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
            return true;
        }
    ...
    private class ChartScaleGestureListener extends SimpleOnScaleGestureListener {
