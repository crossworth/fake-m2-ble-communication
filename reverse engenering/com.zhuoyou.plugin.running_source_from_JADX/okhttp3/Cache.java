...
public final class Cache implements Closeable, Flushable {
    ...
    class C19861 implements InternalCache {
        C19861() {
        }
    ...
    class C19872 implements Iterator<String> {
        boolean canRemove;
        final Iterator<Snapshot> delegate = Cache.this.cache.snapshots();
        String nextUrl;

        C19872() throws IOException {
        }
    ...
    private CacheRequest put(Response response) throws IOException {
        ...
        } else if (!requestMethod.equals(Constants.HTTP_GET) || OkHeaders.hasVaryAll(response)) {
            return null;
        } else {
