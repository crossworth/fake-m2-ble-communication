...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new C20114();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C20081();
    ...
    private final LinkedHashMap<String, Entry> lruEntries = new LinkedHashMap(0, ColumnChartData.DEFAULT_FILL_RATIO, true);
    ...
    class C20103 implements Iterator<Snapshot> {
    ...
    static class C20114 implements Sink {
        C20114() {
        }
    ...
    public final class Editor {
        ...
        public Sink newSink(int index) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    c20121 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
    ...
    private synchronized okhttp3.internal.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        ...
        r1 = (okhttp3.internal.DiskLruCache.Entry) r1;	 Catch:{ all -> 0x0064 }
        r2 = -1;
    ...
    L_0x004f:
        r1 = new okhttp3.internal.DiskLruCache$Entry;	 Catch:{ all -> 0x0064 }
        r2 = 0;
        r1.<init>(r5);	 Catch:{ all -> 0x0064 }
        r2 = r4.lruEntries;	 Catch:{ all -> 0x0064 }
        r2.put(r5, r1);	 Catch:{ all -> 0x0064 }
    L_0x005a:
        r0 = new okhttp3.internal.DiskLruCache$Editor;	 Catch:{ all -> 0x0064 }
        r2 = 0;
