...
public final class HttpEngine {
    private static final ResponseBody EMPTY_BODY = new C20321();
    ...
    static class C20321 extends ResponseBody {
        C20321() {
        }
...
*/
    ...
    private HttpStream connect() throws RouteException, RequestException, IOException {
        return this.streamAllocation.newStream(this.client.connectTimeoutMillis(), this.client.readTimeoutMillis(), this.client.writeTimeoutMillis(), this.client.retryOnConnectionFailure(), !this.networkRequest.method().equals(Constants.HTTP_GET));
    }
    ...
    private Response unzip(Response response) throws IOException {
        if (!this.transparentGzip || !com.tyd.aidlservice.internal.Constants.GZIP_TAG.equalsIgnoreCase(this.userResponse.header(com.tyd.aidlservice.internal.Constants.HTTP_HEADER_CONTENT_ENCODING)) || response.body() == null) {
            return response;
        }
        Source responseBody = new GzipSource(response.body().source());
        Headers strippedHeaders = response.headers().newBuilder().removeAll(com.tyd.aidlservice.internal.Constants.HTTP_HEADER_CONTENT_ENCODING).removeAll("Content-Length").build();
    ...
    private Request networkRequest(Request request) throws IOException {
        ...
        if (request.header("Accept-Encoding") == null) {
            ...
            result.header("Accept-Encoding", com.tyd.aidlservice.internal.Constants.GZIP_TAG);
        }
    ...
    L_0x0095:
        r10 = r12.client;
        r10 = r10.followSslRedirects();
        if (r10 == 0) goto L_0x0026;
    L_0x009d:
        r10 = r12.userRequest;
        r3 = r10.newBuilder();
        r10 = okhttp3.internal.http.HttpMethod.permitsRequestBody(r2);
        if (r10 == 0) goto L_0x00c3;
    L_0x00a9:
        r10 = okhttp3.internal.http.HttpMethod.redirectsToGet(r2);
