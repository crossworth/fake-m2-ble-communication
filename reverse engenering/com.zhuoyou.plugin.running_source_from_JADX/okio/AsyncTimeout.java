    ...
    private static synchronized AsyncTimeout awaitTimeout() throws InterruptedException {
        ...
        synchronized (AsyncTimeout.class) {
            ...
            if (node == null) {
                ...
                if (waitNanos > 0) {
                    long waitMillis = waitNanos / TimeConstants.NANOSECONDS_PER_MILLISECOND;
                    AsyncTimeout.class.wait(waitMillis, (int) (waitNanos - (waitMillis * TimeConstants.NANOSECONDS_PER_MILLISECOND)));
                    node = null;
                } else {
                    head.next = node.next;
                    node.next = null;
