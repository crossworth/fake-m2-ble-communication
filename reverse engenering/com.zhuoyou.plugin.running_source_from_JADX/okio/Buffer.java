...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    class C20371 extends OutputStream {
        C20371() {
        }
    ...
    class C20382 extends InputStream {
        C20382() {
        }
    ...
    public long readLong() {
        ...
        int limit = segment.limit;
        if (limit - pos < 8) {
            return ((((long) readInt()) & DataConstants.UNSIGNED_INT_MAX_VALUE) << 32) | (((long) readInt()) & DataConstants.UNSIGNED_INT_MAX_VALUE);
        }
        byte[] data = segment.data;
        int pos2 = pos + 1;
        pos = pos2 + 1;
    ...
    public String readUtf8LineStrict() throws EOFException {
        ...
        throw new EOFException("\\n not found: size=" + size() + " content=" + data.readByteString().hex() + Util.TEXT_POSTFIX);
    }
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        byte b0 = getByte(0);
        if ((b0 & 128) == 0) {
            codePoint = b0 & TransportMediator.KEYCODE_MEDIA_PAUSE;
            byteCount = 1;
            min = 0;
        } else if ((b0 & 224) == 192) {
            codePoint = b0 & 31;
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        int width = v < 100000000 ? v < 10000 ? v < 100 ? v < 10 ? 1 : 2 : v < 1000 ? 3 : 4 : v < TimeConstants.NANOSECONDS_PER_MILLISECOND ? v < 100000 ? 5 : 6 : v < 10000000 ? 7 : 8 : v < 1000000000000L ? v < 10000000000L ? v < TimeConstants.NANOSECONDS_PER_SECOND ? 9 : 10 : v < 100000000000L ? 11 : 12 : v < 1000000000000000L ? v < 10000000000000L ? 13 : v < 100000000000000L ? 14 : 15 : v < 100000000000000000L ? v < 10000000000000000L ? 16 : 17 : v < 1000000000000000000L ? 18 : 19;
        if (negative) {
            width++;
        }
    ...
    Segment writableSegment(int minimumCapacity) {
        if (minimumCapacity < 1 || minimumCapacity > 2048) {
            ...
            r0 = this.head.prev;
            if (r0.limit + minimumCapacity > 2048 || !r0.owner) {
