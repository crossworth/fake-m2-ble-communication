    ...
    private void init(JSONObject json) throws TwitterException {
        ...
        try {
            ...
            if (!json.isNull("entities")) {
                ...
                if (!entities.isNull(SocializeConstants.KEY_PLATFORM)) {
                    mediaArray = entities.getJSONArray(SocializeConstants.KEY_PLATFORM);
            ...
            if (!json.isNull("extended_entities")) {
                ...
                if (!extendedEntities.isNull(SocializeConstants.KEY_PLATFORM)) {
                    mediaArray = extendedEntities.getJSONArray(SocializeConstants.KEY_PLATFORM);
                    len = mediaArray.length();
            ...
            if (!json.isNull("current_user_retweet")) {
                this.currentUserRetweetId = json.getJSONObject("current_user_retweet").getLong(ShareConstants.WEB_DIALOG_PARAM_ID);
            }
            if (!json.isNull("lang")) {
