...
class ConfigurationBase implements Configuration, Serializable {
    ...
    private HttpClientConfiguration httpConf = new MyHttpClientConfiguration(null, null, null, -1, BaseImageDownloader.DEFAULT_HTTP_READ_TIMEOUT, 120000, false, true);
    ...
    class MyHttpClientConfiguration implements HttpClientConfiguration, Serializable {
        ...
        private int httpConnectionTimeout = BaseImageDownloader.DEFAULT_HTTP_READ_TIMEOUT;
    ...
    public boolean equals(Object o) {
        ...
        if (this.includeEmailEnabled != that.includeEmailEnabled) {
            return false;
        }
        ...
        if (this.includeExtAltTextEnabled != that.includeExtAltTextEnabled) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        i2 = (i2 + hashCode) * 31;
        if (this.includeExtAltTextEnabled) {
            hashCode = 1;
        } else {
            hashCode = 0;
        }
