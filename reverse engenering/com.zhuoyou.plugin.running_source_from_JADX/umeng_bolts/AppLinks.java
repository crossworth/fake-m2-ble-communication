...
public final class AppLinks {
    ...
    public static Bundle getAppLinkExtras(Intent intent) {
        ...
        return appLinkData == null ? null : appLinkData.getBundle(KEY_NAME_EXTRAS);
    }
    ...
    public static Uri getTargetUrlFromInboundIntent(Context context, Intent intent) {
        ...
        MeasurementEvent.sendBroadcastEvent(context, MeasurementEvent.APP_LINK_NAVIGATE_IN_EVENT_NAME, intent, (Map) null);
        return Uri.parse(targetString);
    }
}
