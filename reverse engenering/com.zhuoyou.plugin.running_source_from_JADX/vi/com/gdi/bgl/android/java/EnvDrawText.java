...
public class EnvDrawText {
    private static final String f5023a = EnvDrawText.class.getSimpleName();
    public static boolean bBmpChange = false;
    public static Bitmap bmp = null;
    public static int[] buffer = null;
    public static Canvas canvasTemp = null;
    public static SparseArray<C2201a> fontCache = null;
    ...
    public static synchronized int[] drawText(String str, int i, int i2, int[] iArr, int i3, int i4, int i5, int i6) {
        ...
        synchronized (EnvDrawText.class) {
            ...
            String f = C0671f.m2178f();
            if (f != null && f.equals("vivo X3L")) {
                i2 = 0;
            }
            switch (i2) {
                case 1:
            ...
            if (!(i2 == 0 || fontCache == null)) {
                C2201a c2201a = (C2201a) fontCache.get(i2);
                if (c2201a != null) {
                    pt.setTypeface(c2201a.f5024a);
                }
            }
    ...
    public static synchronized void registFontCache(int i, Typeface typeface) {
        synchronized (EnvDrawText.class) {
            if (!(i == 0 || typeface == null)) {
                ...
                C2201a c2201a = (C2201a) fontCache.get(i);
                if (c2201a == null) {
                    c2201a = new C2201a();
                    c2201a.f5024a = typeface;
                    c2201a.f5025b++;
                    fontCache.put(i, c2201a);
                } else {
                    c2201a.f5025b++;
                }
            }
